...
jacoInvocation="$java_command -classpath $serverClassesDir$separator$resourceDir$separator$jacoClasspath$separator$CLASSPATH $jacoOrbClass $jacoSingletonOrbClass $jacoNameIOR"
