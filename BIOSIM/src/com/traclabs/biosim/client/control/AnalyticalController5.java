 ...
 */
public class AnalyticalController5 implements BiosimController {
	public static final String CONFIGURATION_FILE = "kirsten/MurderControllerInit_VolumeChange.xml";
	...
	public AnalyticalController5(boolean log) {
		...
		try{
			out = new FileOutputStream("Configuration5Result.txt", true);		
		}catch (Exception e){
			System.out.println("Can't open Configuration5Result.txt.");
		}
	...
	public static void main(String[] args) {
		...
		int max = 5000;
		for (int i = 0; i < max; i ++){
			AnalyticalController5 myController = new AnalyticalController5(logToFile);
