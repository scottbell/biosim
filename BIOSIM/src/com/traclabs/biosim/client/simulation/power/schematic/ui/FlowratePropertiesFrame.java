...
public abstract class FlowratePropertiesFrame extends JFrame {
	...
	public FlowratePropertiesFrame(FigModuleEdge pEdge,
			SingleFlowRateControllable pOpertations) {
		...
		myDesiredField = new JFormattedTextField(NumberFormat
				.getNumberInstance());
		myDesiredField.setValue(new Float(myOperations
				.getDesiredFlowRate(myIndex)));
