...
/**
 * The Nitrogen Store Server. Creates an instance of the NitrogenStore and
...
public class NitrogenStoreServer extends GenericServer {
    ...
    public static void main(String args[]) {
        ...
        NitrogenStoreImpl myNitrogenStore = new NitrogenStoreImpl(GenericServer
                .getIDfromArgs(args), GenericServer.getNamefromArgs(args));
        myServer.registerServerAndRun(new NitrogenStorePOATie(myNitrogenStore),
                myNitrogenStore.getModuleName(), myNitrogenStore.getID());
    }
}
