...
public class CRS extends AirRSSubSystem {
    ...
    private void gatherGasses() {
        ...
        currentCO2Consumed = SimBioModuleImpl.getResourceFromStore(myAirRS
                .getCO2Inputs(), myAirRS.getCO2InputMaxFlowRates(), myAirRS
                .getCO2InputDesiredFlowRates(), myAirRS
                .getCO2InputActualFlowRates(), filteredCO2Needed);
        currentH2Consumed = SimBioModuleImpl.getResourceFromStore(myAirRS
                .getH2Inputs(), myAirRS.getH2InputMaxFlowRates(), myAirRS
                .getH2InputDesiredFlowRates(), myAirRS
                .getH2InputActualFlowRates(), filteredH2Needed);
    }
    ...
    private void pushGasses() {
        if ((currentH2Consumed <= 0) || (currentCO2Consumed <= 0)) {
            ...
            SimBioModuleImpl.pushResourceToStore(myAirRS.getH2Inputs(), myAirRS
                    .getH2InputMaxFlowRates(), myAirRS
                    .getH2InputDesiredFlowRates(), myAirRS
                    .getH2InputActualFlowRates(), currentH2Consumed);
            SimBioModuleImpl.pushResourceToStore(myAirRS.getCO2Inputs(),
                    myAirRS.getCO2InputMaxFlowRates(), myAirRS
                            .getCO2InputDesiredFlowRates(), myAirRS
                            .getCO2InputActualFlowRates(), currentCO2Consumed);
        } else {
            // CO2 + 4H2 --> CH4 + 2H20
            ...
            if (limitingReactant == currentH2Consumed)
                SimBioModuleImpl.pushResourceToStore(myAirRS.getCO2Inputs(),
                        myAirRS.getCO2InputMaxFlowRates(), myAirRS
                                .getCO2InputDesiredFlowRates(), myAirRS
                                .getCO2InputActualFlowRates(),
                        currentCO2Consumed - limitingReactant);
            else
                SimBioModuleImpl.pushResourceToStore(myAirRS.getH2Inputs(),
                        myAirRS.getH2InputMaxFlowRates(), myAirRS
                                .getH2InputDesiredFlowRates(), myAirRS
                                .getH2InputActualFlowRates(), currentH2Consumed
                                - 4f * limitingReactant);
        ...
        float distributedWaterLeft = SimBioModuleImpl.pushResourceToStore(
                myAirRS.getPotableWaterOutputs(), myAirRS
                        .getPotableWaterOutputMaxFlowRates(), myAirRS
                        .getPotableWaterOutputDesiredFlowRates(), myAirRS
