...
/**
 * The Sim Environment Server. Creates an instance of the Sim Environment and
...
public class SimEnvironmentServer extends GenericServer {
    ...
    public static void main(String args[]) {
        ...
        SimEnvironmentImpl mySimEnvironment = new SimEnvironmentImpl(
                GenericServer.getIDfromArgs(args), GenericServer
                        .getNamefromArgs(args));
        myServer.registerServerAndRun(
                new SimEnvironmentPOATie(mySimEnvironment), mySimEnvironment
                        .getModuleName(), mySimEnvironment.getID());
    }
}
