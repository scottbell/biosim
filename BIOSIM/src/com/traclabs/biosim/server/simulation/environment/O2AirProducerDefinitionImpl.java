...
import com.traclabs.biosim.idl.simulation.environment.O2AirProducerDefinitionHelper;
import com.traclabs.biosim.idl.simulation.environment.O2AirProducerDefinitionOperations;
import com.traclabs.biosim.idl.simulation.environment.O2AirProducerDefinitionPOATie;
...
public class O2AirProducerDefinitionImpl extends
        StoreEnvironmentFlowRateControllableImpl implements
        O2AirProducerDefinitionOperations {
    private O2AirProducerDefinition myO2AirProducerDefinition;

    public O2AirProducerDefinitionImpl() {
        myO2AirProducerDefinition = O2AirProducerDefinitionHelper
                .narrow(OrbUtils
                        .poaToCorbaObj(new O2AirProducerDefinitionPOATie(this)));
    }
    ...
    public void setO2AirEnvironmentOutputs(SimEnvironment[] pEnvironments,
    ...
    public void setO2AirStoreOutputs(O2Store[] pStores, float[] pMaxFlowRates,
    ...
    public float pushO2ToEnvironment(float pMolesToPush) {
        ...
        for (int i = 0; (i < getEnvironments().length) && (O2AirLeft > 0); i++) {
