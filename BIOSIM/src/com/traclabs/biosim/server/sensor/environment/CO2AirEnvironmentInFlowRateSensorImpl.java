...
public class CO2AirEnvironmentInFlowRateSensorImpl extends GenericSensorImpl
        implements CO2AirEnvironmentInFlowRateSensorOperations {
    ...
    protected void gatherData() {
        float preFilteredValue = getInput()
                .getCO2AirEnvironmentInputActualFlowRate(myIndex);
