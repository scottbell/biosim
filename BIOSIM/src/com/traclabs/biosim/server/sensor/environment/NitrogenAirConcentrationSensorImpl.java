...
public class NitrogenAirConcentrationSensorImpl extends EnvironmentSensorImpl
        implements NitrogenAirConcentrationSensorOperations {
    public NitrogenAirConcentrationSensorImpl(int pID, String pName) {
        super(pID, pName);
    }

    protected void gatherData() {
        float preFilteredValue = getInput().getNitrogenMoles()
