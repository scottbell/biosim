...
then
	...
	echo "				-compiling mission skeletons/stubs"
	$compilationInvocation $simSkeletonDir/idl/simulation/mission/*.java
...
echo "				-compiling mission implementation"
$compilationInvocation $serverDir/simulation/mission/*.java
