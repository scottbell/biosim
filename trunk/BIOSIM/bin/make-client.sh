...
compilationInvocation="$javac_command -d $clientClassesDir -classpath $separator$stubDir$separator$clientClassesDir$separator$sourceDir$separator$jacoClasspath"
if [ "$userSelect" == "all" ]; then
