...
chartClasspath="$devRootDir/lib/chart2d/chart2d.jar"
jacoClasspath="$JACORB_HOME/jacorb.jar$separator$JRE_HOME/lib/rt.jar$separator$JACORB_HOME"
jacoInvocation="$java_command -client -classpath $chartClasspath$separator$clientClassesDir$separator$jacoClasspath$separator$resourceDir $jacoOrbClass $jacoSingletonOrbClass $jacoNameIOR"
