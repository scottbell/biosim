...
\item {\tt DirtyWaterInFlowRateActuator}: Changes how much dirty water (in liters) goes out of the module
\item {\tt DirtyWaterOutFlowRateActuator}: Changes how much dirty water (in liters) goes into the module
\item {\tt GreyWaterInFlowRateActuator}: Changes how much grey water (in liters) goes out of the module
\item {\tt GreyWaterOutFlowRateActuator}: Changes how much grey water (in liters) goes into the module
\item {\tt PotableWaterInFlowRateActuator}: Changes how much potable water (in liters) goes out of the module
\item {\tt PotableWaterOutFlowRateActuator}: Changes how much potable water (in liters) goes into the module
\end{enumerate}
