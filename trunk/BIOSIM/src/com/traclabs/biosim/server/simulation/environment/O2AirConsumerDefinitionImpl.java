...
import com.traclabs.biosim.idl.simulation.environment.O2AirConsumerDefinitionHelper;
import com.traclabs.biosim.idl.simulation.environment.O2AirConsumerDefinitionOperations;
import com.traclabs.biosim.idl.simulation.environment.O2AirConsumerDefinitionPOATie;
...
public class O2AirConsumerDefinitionImpl extends
        StoreEnvironmentFlowRateControllableImpl implements
        O2AirConsumerDefinitionOperations {
    private O2AirConsumerDefinition myO2AirConsumerDefinition;

    public O2AirConsumerDefinitionImpl() {
        myO2AirConsumerDefinition = O2AirConsumerDefinitionHelper
                .narrow(OrbUtils
                        .poaToCorbaObj(new O2AirConsumerDefinitionPOATie(this)));
    }
    ...
    public void setO2AirEnvironmentInputs(SimEnvironment[] pEnvironments,
    ...
    public void setO2AirStoreInputs(O2Store[] pStores, float[] pMaxFlowRates,
