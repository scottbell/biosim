...
/**
 * The Crew Server. Creates an instance of the Crew and registers it with the
 * nameserver.
 * 
 * @author Scott Bell
 */
...
public class CrewGroupServer extends GenericServer {
    ...
    public static void main(String args[]) {
        ...
        CrewGroupImpl myCrewGroup = new CrewGroupImpl(GenericServer
                .getIDfromArgs(args), GenericServer.getNamefromArgs(args));
        myServer.registerServerAndRun(new CrewGroupPOATie(myCrewGroup),
