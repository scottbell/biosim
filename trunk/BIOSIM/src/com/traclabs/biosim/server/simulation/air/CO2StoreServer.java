...
/**
 * The CO2 Store Server. Creates an instance of the CO2Store and registers it
 * with the nameserver.
 * 
 * @author Scott Bell
 */
...
public class CO2StoreServer extends GenericServer {
    ...
    public static void main(String args[]) {
        ...
        CO2StoreImpl myCO2Store = new CO2StoreImpl(GenericServer
                .getIDfromArgs(args), GenericServer.getNamefromArgs(args));
        myServer.registerServerAndRun(new CO2StorePOATie(myCO2Store),
