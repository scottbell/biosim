...
/**
 * The Food Store Server. Creates an instance of the Food Processor and
...
public class FoodStoreServer extends GenericServer {
    ...
    public static void main(String args[]) {
        ...
        FoodStoreImpl myFoodStore = new FoodStoreImpl(GenericServer
                .getIDfromArgs(args), GenericServer.getNamefromArgs(args));
        myServer.registerServerAndRun(new FoodStorePOATie(myFoodStore),
