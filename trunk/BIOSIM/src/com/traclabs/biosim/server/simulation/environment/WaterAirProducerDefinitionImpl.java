...
import com.traclabs.biosim.idl.simulation.environment.WaterAirProducerDefinitionHelper;
import com.traclabs.biosim.idl.simulation.environment.WaterAirProducerDefinitionOperations;
import com.traclabs.biosim.idl.simulation.environment.WaterAirProducerDefinitionPOATie;
...
public class WaterAirProducerDefinitionImpl extends
        StoreEnvironmentFlowRateControllableImpl implements
        WaterAirProducerDefinitionOperations {
    private WaterAirProducerDefinition myWaterAirProducerDefinition;

    public WaterAirProducerDefinitionImpl() {
        myWaterAirProducerDefinition = WaterAirProducerDefinitionHelper
                .narrow(OrbUtils
                        .poaToCorbaObj(new WaterAirProducerDefinitionPOATie(
                                this)));
    }
    ...
    public void setWaterAirEnvironmentOutputs(SimEnvironment[] pEnvironments,
    ...
    public void setWaterAirStoreOutputs(WaterStore[] pStores,
            float[] pMaxFlowRates, float[] pDesiredFlowRates) {
        setStores(pStores);
    ...
    public float pushWaterToEnvironment(float pMolesToPush) {
        ...
        for (int i = 0; (i < getEnvironments().length) && (WaterAirLeft > 0); i++) {
