...
/**
 * The Food Processor Server. Creates an instance of the Food Processor and
...
public class FoodProcessorServer extends GenericServer {
    ...
    public static void main(String args[]) {
        ...
        FoodProcessorImpl myFoodProcessor = new FoodProcessorImpl(GenericServer
                .getIDfromArgs(args), GenericServer.getNamefromArgs(args));
        myServer.registerServerAndRun(new FoodProcessorPOATie(myFoodProcessor),
                myFoodProcessor.getModuleName(), myFoodProcessor.getID());
    }
}
