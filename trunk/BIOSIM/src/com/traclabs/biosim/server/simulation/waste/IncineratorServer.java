...
/**
 * The Incinerator Server. Creates an instance of the Incinerator and registers
...
public class IncineratorServer extends GenericServer {
    ...
    public static void main(String args[]) {
        ...
        IncineratorImpl myIncinerator = new IncineratorImpl(GenericServer
                .getIDfromArgs(args), GenericServer.getNamefromArgs(args));
        myServer.registerServerAndRun(new IncineratorPOATie(myIncinerator),
                myIncinerator.getModuleName(), myIncinerator.getID());
    }
}
