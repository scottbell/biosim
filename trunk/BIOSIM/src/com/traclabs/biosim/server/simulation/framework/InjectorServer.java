...
/**
 * The Injector Server. Creates an instance of the Sim Environment and registers
...
public class InjectorServer extends GenericServer {
     ...
     * 
     * @param args
     *            first argument checked for ID of server
     */
    public static void main(String args[]) {
        InjectorServer myServer = new InjectorServer();
        InjectorImpl myInjector = new InjectorImpl(GenericServer
                .getIDfromArgs(args), GenericServer.getNamefromArgs(args));
        myServer.registerServerAndRun(new InjectorPOATie(myInjector),
