...
/**
 * A controller to end and change the simulation based on gas composition. For
 * GA use ONLY
 * 
...
public class MurderController implements BiosimController {
	...
	private static final String LOG_FILE = "Configuration.txt";
	...
	public void printConfigurations() {
		...
		myOutput.println("Crop area = "
				+ myBioHolder.theBiomassPSModules.get(0).getShelf(0)
						.getCropAreaUsed() + " " + "CO2Segment1Time ="
				+ myCO2Segment1Time + " " + "CO2Segment2Time ="
				+ myCO2Segment2Time + " " + "CO2Segment3Time ="
				+ myCO2Segment3Time + " " + "myCO2Segment1SetPoint ="
				+ myCO2Segment1SetPoint + " " + "myCO2Segment2SetPoint ="
				+ myCO2Segment2SetPoint + " " + "myCO2Segment3SetPoint ="
				+ myCO2Segment3SetPoint + " " + "myO2SetPoint =" + myO2SetPoint
				+ " " + "myO2LowRate =" + myO2LowRate + " " + "myO2HighRate ="
				+ myO2HighRate + " " + "myTotalPressureHighRate ="
				+ myTotalPressureHighRate + " " + "myTotalPressureLowRate ="
				+ myTotalPressureLowRate + " " + "myCO2Segment1LowRate ="
				+ myCO2Segment1LowRate + " " + "myCO2Segment2LowRate ="
				+ myCO2Segment2LowRate + " " + "myCO2Segment3LowRate ="
				+ myCO2Segment3LowRate + " " + "myCO2Segment3LowRate ="
				+ myCO2Segment3LowRate + " " + "myCO2Segment1HighRate ="
				+ myCO2Segment1HighRate + " " + "myCO2Segment2HighRate ="
				+ myCO2Segment2HighRate + " " + "myCO2Segment3HighRate ="
				+ myCO2Segment3HighRate + " " + "ArrivalTime =" + ArrivalTime);
