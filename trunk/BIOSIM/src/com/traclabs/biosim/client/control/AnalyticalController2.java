...
public class AnalyticalController2 implements BiosimController {
	
	public static final String CONFIGURATION_FILE = "kirsten/MurderControllerInit.xml";

	private static final String LOG_FILE = "AnalyticalController2.txt";
	...
	private float myCropArea = (float)(200 * rGenerator.nextDouble());
	
	private int numberFromMonteCarlo = (int)(Math.random() * 8);
	...
	public AnalyticalController2(boolean log) {
		logToFile = log;
		OrbUtils.initializeLog();
		myLogger = Logger.getLogger(this.getClass());
		try{
			out = new FileOutputStream("Configuration2Result.txt", true);		
		}catch (Exception e){
			System.out.println("Can't open Configuration2Result.txt.");
		}
...
/*	private void printHeader(){
		...
		myOutput.println("Crop Type is" + numberFromMonteCarlo);
