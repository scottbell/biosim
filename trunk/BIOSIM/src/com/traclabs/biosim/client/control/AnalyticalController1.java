...
public class AnalyticalController1 implements BiosimController {
	
	public static final String CONFIGURATION_FILE = "kirsten/MurderControllerInit.xml";

	private static final String LOG_FILE = "AnalyticalController1.txt";
	...
	public AnalyticalController1(boolean log) {
		...
		try{
			out = new FileOutputStream("Configuration1Result.txt", true);		
		}catch (Exception e){
			System.out.println("Can't open Configuration1Result.txt.");
		}
	...
	public static void main(String[] args) {
		...
		int max = 5000;
		for (int i = 0; i < max; i ++){
			AnalyticalController1 myController = new AnalyticalController1(logToFile);
