 ...
 * @author Haibei
 * Configuration 6, change total area and Crop Mix, change volume and take plant death into consideration
 * 
 */
public class AnalyticalController6 implements BiosimController {
	...
	public AnalyticalController6(boolean log) {
		logToFile = log;
		OrbUtils.initializeLog();
		myLogger = Logger.getLogger(this.getClass());
		try{
			out = new FileOutputStream("Configuration6Result.txt", true);		
		}catch (Exception e){
			System.out.println("Can't open Configuration6Result.txt.");
		}
	...
	public static void main(String[] args) {
		...
		int max = 5000;
		for (int i = 0; i < max; i ++){
			AnalyticalController6 myController = new AnalyticalController6(logToFile);
...
*/
	...
	public void printConfigurations() {
		...
		myOutput.println();
		myOutput.print("Crop Area Total is" + myCropAreaTotal  + " Total Volume is " + myVolume);
		...
		myOutput.print(" Crop area 4= "+ myBioHolder.theBiomassPSModules.get(0).getShelf(3).getCropAreaUsed()+ " " + "Crop Type 4 is" + numberFromMonteCarlo4);
		myOutput.print(" Crop area 5= "+ myBioHolder.theBiomassPSModules.get(0).getShelf(4).getCropAreaUsed()+ " " + "Crop Type 5 is" + numberFromMonteCarlo5);
		myOutput.print(" Crop area 6= "+ myBioHolder.theBiomassPSModules.get(0).getShelf(5).getCropAreaUsed()+ " " + "Crop Type 6 is" + numberFromMonteCarlo6);
		myOutput.print(" Crop area 7= "+ myBioHolder.theBiomassPSModules.get(0).getShelf(6).getCropAreaUsed()+ " " + "Crop Type 7 is" + numberFromMonteCarlo7);
		myOutput.print(" Crop area 8= "+ myBioHolder.theBiomassPSModules.get(0).getShelf(7).getCropAreaUsed()+ " " + "Crop Type 8 is" + numberFromMonteCarlo8);
		myOutput.print(" Crop area 9= "+ myBioHolder.theBiomassPSModules.get(0).getShelf(8).getCropAreaUsed()+ " " + "Crop Type 9 is" + numberFromMonteCarlo9);
		myOutput.print(" CO2Segment1Time =" + myCO2Segment1Time +" "+"CO2Segment2Time =" + myCO2Segment2Time +" "+ "CO2Segment3Time =" + myCO2Segment3Time + " "+ "myCO2Segment1SetPoint =" + myCO2Segment1SetPoint +" "+ "myCO2Segment2SetPoint =" + myCO2Segment2SetPoint +" "+ "myCO2Segment3SetPoint =" + myCO2Segment3SetPoint +" "+ "myO2SetPoint =" + myO2SetPoint +" "+ "myO2LowRate =" + myO2LowRate +" "+ "myO2HighRate =" + myO2HighRate+" " + "myTotalPressureHighRate =" + myTotalPressureHighRate +" "+  "myTotalPressureLowRate =" + myTotalPressureLowRate+" "+ "myCO2Segment1LowRate =" + myCO2Segment1LowRate +" "+ "myCO2Segment2LowRate =" + myCO2Segment2LowRate +" "+ "myCO2Segment3LowRate =" + myCO2Segment3LowRate +" "+ "myCO2Segment3LowRate =" + myCO2Segment3LowRate+" " + "myCO2Segment1HighRate =" + myCO2Segment1HighRate +" "+ "myCO2Segment2HighRate =" + myCO2Segment2HighRate +" "+ "myCO2Segment3HighRate =" + myCO2Segment3HighRate +" "+ "ArrivalTime =" + ArrivalTime);
