...
public class Fnorder{
	...
	String[] names = {
	                         ...
	                         "The Illigitimus ", "Abraham Lincoln ", "Agent Orange ","Bill Gates ",
	                         "Albert Einstein ", "Alfred E. Neumann ", "Ali Baba ", "Aladdin ",
	                         "William Kida ", "a shadowy figure ", "Batman ", "Buck Rogers ","Calvin ",
	                         "Chow Yun Fat ", "Captain Ahab ", "Captain America ", "Captain Kirk ",
	                         "Ratbert ", "Dogbert ", "Cthulhu ", "Dan Quayle ","Dilbert ",
	                         "Darth Vader ", "Dave Letterman ", "Uncle Bob ", "Dr. Destructo ",
	                         "Dracula ", "Eddie Murphy ", "Edgar Rice Burroughs ", "Elvis ",
	                         "Michael Jackson ", "Evil Stevie ", "Fearless Leader ",
	                         ...
	                         "Jimmy Carter ", "Mayor McCheese ", "Madonna ",
	                         "Joseph Stalin ", "George Bush, Jr. ", "King Arthur ", "King Tut ",
	                         "Lex Luthor ", "Luke Skywalker ", "Manuel Noriega ",
	                         "Margaret Thatcher ", "Michael Jordan ", "Mick Jagger ",
	                         "Mohammed ", "Moses ", "Butt-head ", "Beevis ", "Mr. Science ",
	                         "Mr. Spock ", "Biff ", "Nancy Reagan ", "Nelson Mandela ", "Nixon ",
	                         "Norman Bates ", "Obi-Wan Kenobi ", "Oliver North ", "Paul ",
	                         "Zorro ", "Perry Mason ", "President Clinton ", "Princess Leia ",
	                         "Rambo ", "John Gray, Ph.D ", "Ringo ", "Robby the Robot ",
	                         "Robert Heinlein ", "Rocky ", "Roger Rabbit ", "Ronald Reagan ",
	                         "Scrooge ", "Sir Lancelot ", "Snoopy ", "Spaceman Spiff ",
	                         "Spiderman ", "Squad 23 ", "Tom Petty ", "Steven Spielberg ", "Superman ",
	                         "the A.C.L.U. ", "The Computer ", "the Discordian ", "the network guy ",
	                         ...
	                         "Archangel Gabriel ","O.J. Simpson ", "Karie Norman ", "Scott Bell ", "David Kortenkamp ", "Bryn Wolfe ", "Tod Milam "
	                 };
	...
	String[] nouns = {
	                         ...
	                         "playtester ", "pop tart ", "power drill ","propeller ", "ptarmigan ",
	                         "pterodactyl ",
	...
	public Fnorder() {
		Date currentDate = new Date(); //used for seed in generating random numbers
