	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.framework.AccumulatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getBiomassProducerDefinition", new java.lang.Integer(8));
		...
		m_opsHash.put ( "getNitrogenConsumerDefinition", new java.lang.Integer(12));
		m_opsHash.put ( "fixMalfunction", new java.lang.Integer(13));
		m_opsHash.put ( "getGreyWaterConsumerDefinition", new java.lang.Integer(14));
		m_opsHash.put ( "getPotableWaterProducerDefinition", new java.lang.Integer(15));
		m_opsHash.put ( "getMyTicks", new java.lang.Integer(16));
		m_opsHash.put ( "getMalfunctions", new java.lang.Integer(17));
		m_opsHash.put ( "getBiomassConsumerDefinition", new java.lang.Integer(18));
		m_opsHash.put ( "getFoodConsumerDefinition", new java.lang.Integer(19));
		m_opsHash.put ( "reset", new java.lang.Integer(20));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 8: // getBiomassProducerDefinition
			{
				_out = handler.createReply();
			...
			case 12: // getNitrogenConsumerDefinition
			{
				_out = handler.createReply();
			...
			case 27: // getAirProducerDefinition
			{
				_out = handler.createReply();
			...
			case 35: // getAirConsumerDefinition
			{
				_out = handler.createReply();
