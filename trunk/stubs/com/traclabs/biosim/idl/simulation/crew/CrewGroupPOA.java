	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.crew.CrewGroupOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getDryWasteProducerDefinition", new java.lang.Integer(10));
		m_opsHash.put ( "scheduleRepair", new java.lang.Integer(11));
		m_opsHash.put ( "killCrew", new java.lang.Integer(12));
		m_opsHash.put ( "createCrewPerson", new java.lang.Integer(13));
		m_opsHash.put ( "fixMalfunction", new java.lang.Integer(14));
		m_opsHash.put ( "attachCrewPerson", new java.lang.Integer(15));
		m_opsHash.put ( "getMyTicks", new java.lang.Integer(16));
		m_opsHash.put ( "getGreyWaterProduced", new java.lang.Integer(17));
		m_opsHash.put ( "getO2Consumed", new java.lang.Integer(18));
		m_opsHash.put ( "anyDead", new java.lang.Integer(19));
		...
		m_opsHash.put ( "getCO2Produced", new java.lang.Integer(23));
		...
		m_opsHash.put ( "getFoodConsumed", new java.lang.Integer(28));
		m_opsHash.put ( "log", new java.lang.Integer(29));
		m_opsHash.put ( "detachCrewPerson", new java.lang.Integer(30));
		m_opsHash.put ( "getAirProducerDefinition", new java.lang.Integer(31));
		m_opsHash.put ( "maintain", new java.lang.Integer(32));
		m_opsHash.put ( "setDeathEnabled", new java.lang.Integer(33));
		m_opsHash.put ( "isDead", new java.lang.Integer(34));
		m_opsHash.put ( "getDeathEnabled", new java.lang.Integer(35));
		m_opsHash.put ( "doSomeRepairWork", new java.lang.Integer(36));
		m_opsHash.put ( "getAirConsumerDefinition", new java.lang.Integer(37));
		m_opsHash.put ( "setEnableFailure", new java.lang.Integer(38));
		m_opsHash.put ( "clearAllMalfunctions", new java.lang.Integer(39));
		m_opsHash.put ( "getCrewPeople", new java.lang.Integer(40));
		m_opsHash.put ( "tick", new java.lang.Integer(41));
		m_opsHash.put ( "setTickLength", new java.lang.Integer(42));
		m_opsHash.put ( "getCrewPerson", new java.lang.Integer(43));
		m_opsHash.put ( "getDirtyWaterProducerDefinition", new java.lang.Integer(44));
		m_opsHash.put ( "getCrewSize", new java.lang.Integer(45));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/crew/CrewGroup:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SimBioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/AirConsumer:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/AirProducer:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentConsumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/food/FoodConsumer:1.0","IDL:com/traclabs/biosim/idl/simulation/water/DirtyWaterProducer:1.0","IDL:com/traclabs/biosim/idl/simulation/waste/DryWasteProducer:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentProducer:1.0","IDL:com/traclabs/biosim/idl/simulation/water/GreyWaterProducer:1.0","IDL:com/traclabs/biosim/idl/simulation/water/PotableWaterConsumer:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 17: // getGreyWaterProduced
			{
				_out = handler.createReply();
				_out.write_float(getGreyWaterProduced());
				break;
			}
			case 18: // getO2Consumed
			{
				_out = handler.createReply();
			...
			case 31: // getAirProducerDefinition
			{
				_out = handler.createReply();
