	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.crew.CrewGroupOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "registerCommandListener", new java.lang.Integer(22));
		m_opsHash.put ( "getFoodConsumerDefinition", new java.lang.Integer(23));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 22: // registerCommandListener
			{
			...
			case 23: // getFoodConsumerDefinition
			{
				_out = handler.createReply();
