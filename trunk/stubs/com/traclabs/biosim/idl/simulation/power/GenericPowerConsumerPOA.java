	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.power.GenericPowerConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getPercentageOfPowerAskedDelivered", new java.lang.Integer(14));
		m_opsHash.put ( "scheduleMalfunction", new java.lang.Integer(15));
		m_opsHash.put ( "setPowerRequired", new java.lang.Integer(16));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/power/GenericPowerConsumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SimBioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0","IDL:com/traclabs/biosim/idl/simulation/power/PowerConsumer:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 14: // getPercentageOfPowerAskedDelivered
			{
				_out = handler.createReply();
