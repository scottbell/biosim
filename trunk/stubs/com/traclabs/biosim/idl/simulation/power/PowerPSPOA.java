	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.power.PowerPSOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setCurrentUpperPowerGeneration", new java.lang.Integer(5));
		...
		m_opsHash.put ( "setInitialUpperPowerGeneration", new java.lang.Integer(11));
		m_opsHash.put ( "getLightConsumerDefinition", new java.lang.Integer(12));
		m_opsHash.put ( "doSomeRepairWork", new java.lang.Integer(13));
		m_opsHash.put ( "getID", new java.lang.Integer(14));
		m_opsHash.put ( "getPowerProduced", new java.lang.Integer(15));
		m_opsHash.put ( "scheduleMalfunction", new java.lang.Integer(16));
		m_opsHash.put ( "getModuleName", new java.lang.Integer(17));
		m_opsHash.put ( "getInitialUpperPowerGeneration", new java.lang.Integer(18));
		...
		m_opsHash.put ( "getCurrentUpperPowerGeneration", new java.lang.Integer(27));
		m_opsHash.put ( "getMalfunctions", new java.lang.Integer(28));
		m_opsHash.put ( "fixAllMalfunctions", new java.lang.Integer(29));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/power/PowerPS:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/LightConsumer:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Producer:1.0","IDL:com/traclabs/biosim/idl/simulation/power/PowerProducer:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SimBioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Consumer:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentConsumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 5: // setCurrentUpperPowerGeneration
			{
			...
			case 11: // setInitialUpperPowerGeneration
			{
				float _arg0=_input.read_float();
				_out = handler.createReply();
			...
			case 12: // getLightConsumerDefinition
			{
				_out = handler.createReply();
			...
			case 18: // getInitialUpperPowerGeneration
			{
				_out = handler.createReply();
			...
			case 27: // getCurrentUpperPowerGeneration
			{
				_out = handler.createReply();
