	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.thermal.IATCSOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setIatcsSoftwareState", new java.lang.Integer(11));
		m_opsHash.put ( "fixMalfunction", new java.lang.Integer(12));
		m_opsHash.put ( "getIsolationValveCommandStatus", new java.lang.Integer(13));
		m_opsHash.put ( "getGreyWaterConsumerDefinition", new java.lang.Integer(14));
		m_opsHash.put ( "setPpaPumpSpeedCommandStatus", new java.lang.Integer(15));
		m_opsHash.put ( "setIsloationValveState", new java.lang.Integer(16));
		m_opsHash.put ( "setIatcsState", new java.lang.Integer(17));
		m_opsHash.put ( "getMyTicks", new java.lang.Integer(18));
		m_opsHash.put ( "setBypassValveCommandStatus", new java.lang.Integer(19));
		m_opsHash.put ( "getBypassValveState", new java.lang.Integer(20));
		...
		m_opsHash.put ( "getIatcsSoftwareState", new java.lang.Integer(34));
		m_opsHash.put ( "getBypassValveCommandStatus", new java.lang.Integer(35));
		m_opsHash.put ( "setIsolationValveCommandStatus", new java.lang.Integer(36));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 13: // getIsolationValveCommandStatus
			{
				_out = handler.createReply();
			...
			case 15: // setPpaPumpSpeedCommandStatus
			{
			...
			case 16: // setIsloationValveState
			{
			...
			case 19: // setBypassValveCommandStatus
			{
			...
			case 34: // getIatcsSoftwareState
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.thermal.SoftwareStateHelper.write(_out,getIatcsSoftwareState());
				break;
			}
			case 35: // getBypassValveCommandStatus
			{
				_out = handler.createReply();
				com.traclabs.biosim.idl.simulation.thermal.IFHXValveCommandStatusHelper.write(_out,getBypassValveCommandStatus());
				break;
			}
			case 36: // setIsolationValveCommandStatus
			{
				com.traclabs.biosim.idl.simulation.thermal.IFHXValveCommandStatus _arg0=com.traclabs.biosim.idl.simulation.thermal.IFHXValveCommandStatusHelper.read(_input);
				_out = handler.createReply();
