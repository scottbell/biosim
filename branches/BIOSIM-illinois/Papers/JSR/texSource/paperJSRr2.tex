...
system including the crew, crops, water and air recovery systems, EVAs and power. Since
...
The previous section, entitled \emph{Simulation Overview}, %(Section~\ref{sec:sim_overview}) 
...
analysis of simulation results as described in \emph{Analysis} Section.%~\ref{sec:analysis}.

\subsubsection{Extravehicular Activities}

As described in the \emph{Extravehicular Activities} Section, %~\ref{sec:eva}, 
...
fitness function utilized here are included in the \emph{Fitness Function} Section.%~\ref{sec:fitness}.
...
Depending upon the scenario (see Lunar Habitat Scenarios Section) %~\ref{sec:scenarios})
...
designs for the 90 day Lunar mission described in the \emph{Habitat Parameters} Section.%~\ref{sec:hab}. 
...
maximum value of attribute $i$ (the list of attributes can be found in the \emph{Genes} Section. %~\ref{sec:gene}). 
...
attributes listed in the \emph{Genes} Section.%~\ref{sec:gene}. 
...
five scenarios described in \emph{Lunar Habitat Scenarios} Section. %~\ref{sec:scenarios}.  
This section
...
Each instance of BioSim executes its gene, meaning it configures the BioSim model according to the gene (see the \emph{Genes} Section),%~\ref{sec:gene}), 
...
the \emph{Lunar Habitat Scenarios} Section.%~\ref{sec:scenarios}.  
...
listed in the \emph{Lunar Habitat Scenarios} Section.%~\ref{sec:scenarios}. 
