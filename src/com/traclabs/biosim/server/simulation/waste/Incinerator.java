...
public class Incinerator extends SimBioModule implements
    ...
    public Incinerator(int pID, String pName) {
        super(pID, pName);
    ...
    private void consumeResources() {
        ...
        if (hasEnoughPower) {
            ...
            currentO2Consumed = 0f;
            Arrays.fill(myO2ConsumerDefinition.getActualFlowRates(), 0f);
            currentDryWasteConsumed = 0f;
            Arrays.fill(myDryWasteConsumerDefinition.getActualFlowRates(),
                    0f);
        }
    }
