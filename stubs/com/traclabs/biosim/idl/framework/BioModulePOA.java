	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.framework.BioModuleOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getMyTicks", Integer.valueOf(7));
	...
	public com.traclabs.biosim.idl.framework.BioModule _this()
	{
		...
		com.traclabs.biosim.idl.framework.BioModule __r = com.traclabs.biosim.idl.framework.BioModuleHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult3 = getModuleName();
