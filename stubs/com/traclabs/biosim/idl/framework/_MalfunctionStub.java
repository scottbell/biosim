	...
	implements com.traclabs.biosim.idl.framework.Malfunction
{
	...
	public com.traclabs.biosim.idl.framework.MalfunctionLength getLength()
	{
		...
		else
		{
			...
			com.traclabs.biosim.idl.framework.MalfunctionLength _result;
			try
			{
	...
	public void setPerformed(boolean pPerformed)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setPerformed", true);
	...
	public boolean hasPerformed()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "hasPerformed", true);
					_is = _invoke(_os);
	...
	public com.traclabs.biosim.idl.framework.MalfunctionIntensity getIntensity()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getIntensity", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			MalfunctionOperations _localServant = (MalfunctionOperations)_so.servant;
			com.traclabs.biosim.idl.framework.MalfunctionIntensity _result;
			try
			{
	...
	public boolean doneEnoughRepairWork()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "doneEnoughRepairWork", true);
					_is = _invoke(_os);
					boolean _result = _is.read_boolean();
					return _result;
				}
