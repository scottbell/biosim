	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.power.PowerOutFlowRateActuatorOperations
{
	...
	public com.traclabs.biosim.idl.actuator.power.PowerOutFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.power.PowerOutFlowRateActuator __r = com.traclabs.biosim.idl.actuator.power.PowerOutFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult229 = getModuleName();
_out.write_string( tmpResult229 );
				break;
			}
