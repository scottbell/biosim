	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.power.PowerInFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", Integer.valueOf(11));
	...
	public com.traclabs.biosim.idl.actuator.power.PowerInFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.power.PowerInFlowRateActuator __r = com.traclabs.biosim.idl.actuator.power.PowerInFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult228 = getModuleName();
_out.write_string( tmpResult228 );
				break;
			}
