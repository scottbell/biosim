	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.power.PowerPSActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", Integer.valueOf(23));
	...
	public com.traclabs.biosim.idl.actuator.power.PowerPSActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.power.PowerPSActuator __r = com.traclabs.biosim.idl.actuator.power.PowerPSActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult227 = getModuleName();
_out.write_string( tmpResult227 );
				break;
			}
