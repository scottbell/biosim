...
public abstract class BiomassPSActuatorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(BiomassPSActuatorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/food/BiomassPSActuator:1.0", "BiomassPSActuator");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.actuator.food._BiomassPSActuatorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.actuator.food.BiomassPSActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.actuator.food.BiomassPSActuator)
		{
			return (com.traclabs.biosim.idl.actuator.food.BiomassPSActuator)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/food/BiomassPSActuator:1.0"))
		{
