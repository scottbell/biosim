	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.food.HarvestingActuatorOperations
{
	...
	public com.traclabs.biosim.idl.actuator.food.HarvestingActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.food.HarvestingActuator __r = com.traclabs.biosim.idl.actuator.food.HarvestingActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult226 = getModuleName();
_out.write_string( tmpResult226 );
				break;
			}
