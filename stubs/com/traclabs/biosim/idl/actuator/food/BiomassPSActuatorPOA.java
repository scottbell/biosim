	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.food.BiomassPSActuatorOperations
{
	...
	public com.traclabs.biosim.idl.actuator.food.BiomassPSActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.food.BiomassPSActuator __r = com.traclabs.biosim.idl.actuator.food.BiomassPSActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult218 = getModuleName();
_out.write_string( tmpResult218 );
				break;
			}
