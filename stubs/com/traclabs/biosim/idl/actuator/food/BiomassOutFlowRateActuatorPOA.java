	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.food.BiomassOutFlowRateActuatorOperations
{
	...
	public com.traclabs.biosim.idl.actuator.food.BiomassOutFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.food.BiomassOutFlowRateActuator __r = com.traclabs.biosim.idl.actuator.food.BiomassOutFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult222 = getModuleName();
_out.write_string( tmpResult222 );
				break;
			}
