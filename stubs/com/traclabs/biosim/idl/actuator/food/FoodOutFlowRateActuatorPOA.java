	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.food.FoodOutFlowRateActuatorOperations
{
	...
	public com.traclabs.biosim.idl.actuator.food.FoodOutFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.food.FoodOutFlowRateActuator __r = com.traclabs.biosim.idl.actuator.food.FoodOutFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult224 = getModuleName();
_out.write_string( tmpResult224 );
				break;
			}
