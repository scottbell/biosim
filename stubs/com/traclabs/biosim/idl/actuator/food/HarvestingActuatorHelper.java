...
public abstract class HarvestingActuatorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(HarvestingActuatorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/food/HarvestingActuator:1.0", "HarvestingActuator");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.actuator.food._HarvestingActuatorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.actuator.food.HarvestingActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.actuator.food.HarvestingActuator)
		{
			return (com.traclabs.biosim.idl.actuator.food.HarvestingActuator)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/food/HarvestingActuator:1.0"))
		{
