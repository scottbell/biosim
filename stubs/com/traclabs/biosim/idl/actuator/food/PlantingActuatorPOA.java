	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.food.PlantingActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setPlantType", Integer.valueOf(23));
		...
		m_opsHash.put ( "getOutputModule", Integer.valueOf(28));
	...
	public com.traclabs.biosim.idl.actuator.food.PlantingActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.food.PlantingActuator __r = com.traclabs.biosim.idl.actuator.food.PlantingActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult225 = getModuleName();
_out.write_string( tmpResult225 );
				break;
			}
			case 17: // setOutput
			{
