	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.food.FoodInFlowRateActuatorOperations
{
	...
	public com.traclabs.biosim.idl.actuator.food.FoodInFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.food.FoodInFlowRateActuator __r = com.traclabs.biosim.idl.actuator.food.FoodInFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult223 = getModuleName();
_out.write_string( tmpResult223 );
				break;
			}
