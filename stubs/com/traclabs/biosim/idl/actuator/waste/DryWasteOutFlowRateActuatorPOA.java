	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.waste.DryWasteOutFlowRateActuatorOperations
{
	...
	public com.traclabs.biosim.idl.actuator.waste.DryWasteOutFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.waste.DryWasteOutFlowRateActuator __r = com.traclabs.biosim.idl.actuator.waste.DryWasteOutFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult231 = getModuleName();
_out.write_string( tmpResult231 );
				break;
			}
