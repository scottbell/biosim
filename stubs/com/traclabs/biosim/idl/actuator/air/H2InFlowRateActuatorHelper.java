...
public abstract class H2InFlowRateActuatorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(H2InFlowRateActuatorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/air/H2InFlowRateActuator:1.0", "H2InFlowRateActuator");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.actuator.air._H2InFlowRateActuatorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.actuator.air.H2InFlowRateActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.actuator.air.H2InFlowRateActuator)
		{
			return (com.traclabs.biosim.idl.actuator.air.H2InFlowRateActuator)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/air/H2InFlowRateActuator:1.0"))
		{
