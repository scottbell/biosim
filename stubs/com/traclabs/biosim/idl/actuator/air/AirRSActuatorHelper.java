...
public abstract class AirRSActuatorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(AirRSActuatorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/air/AirRSActuator:1.0", "AirRSActuator");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.actuator.air._AirRSActuatorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.actuator.air.AirRSActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.actuator.air.AirRSActuator)
		{
			return (com.traclabs.biosim.idl.actuator.air.AirRSActuator)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/air/AirRSActuator:1.0"))
		{
