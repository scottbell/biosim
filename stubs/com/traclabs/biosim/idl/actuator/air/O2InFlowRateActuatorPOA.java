	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.air.O2InFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", Integer.valueOf(10));
	...
	public com.traclabs.biosim.idl.actuator.air.O2InFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.air.O2InFlowRateActuator __r = com.traclabs.biosim.idl.actuator.air.O2InFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult202 = getModuleName();
_out.write_string( tmpResult202 );
				break;
			}
