	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.air.MethaneOutFlowRateActuatorOperations
{
	...
	static
	{
		m_opsHash.put ( "setOutput", Integer.valueOf(0));
	...
	public com.traclabs.biosim.idl.actuator.air.MethaneOutFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.air.MethaneOutFlowRateActuator __r = com.traclabs.biosim.idl.actuator.air.MethaneOutFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult212 = getModuleName();
_out.write_string( tmpResult212 );
				break;
			}
