	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.air.NitrogenOutFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getOutput", Integer.valueOf(11));
		...
		m_opsHash.put ( "getIndex", Integer.valueOf(20));
		...
		m_opsHash.put ( "setOutput", Integer.valueOf(25));
		m_opsHash.put ( "log", Integer.valueOf(26));
		m_opsHash.put ( "getOutputModule", Integer.valueOf(27));
		m_opsHash.put ( "getMin", Integer.valueOf(28));
		m_opsHash.put ( "getMalfunctions", Integer.valueOf(29));
		m_opsHash.put ( "fixAllMalfunctions", Integer.valueOf(30));
	}
	...
	public com.traclabs.biosim.idl.actuator.air.NitrogenOutFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.air.NitrogenOutFlowRateActuator __r = com.traclabs.biosim.idl.actuator.air.NitrogenOutFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult210 = getModuleName();
_out.write_string( tmpResult210 );
				break;
			}
