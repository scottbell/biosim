	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.air.H2InFlowRateActuatorOperations
{
	...
	public com.traclabs.biosim.idl.actuator.air.H2InFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.air.H2InFlowRateActuator __r = com.traclabs.biosim.idl.actuator.air.H2InFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult206 = getModuleName();
_out.write_string( tmpResult206 );
				break;
			}
