	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.air.MethaneInFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", Integer.valueOf(15));
	...
	public com.traclabs.biosim.idl.actuator.air.MethaneInFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.air.MethaneInFlowRateActuator __r = com.traclabs.biosim.idl.actuator.air.MethaneInFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult211 = getModuleName();
_out.write_string( tmpResult211 );
				break;
			}
