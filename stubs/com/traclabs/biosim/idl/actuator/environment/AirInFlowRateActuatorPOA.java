	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.environment.AirInFlowRateActuatorOperations
{
	...
	public com.traclabs.biosim.idl.actuator.environment.AirInFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.environment.AirInFlowRateActuator __r = com.traclabs.biosim.idl.actuator.environment.AirInFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult216 = getModuleName();
_out.write_string( tmpResult216 );
				break;
			}
