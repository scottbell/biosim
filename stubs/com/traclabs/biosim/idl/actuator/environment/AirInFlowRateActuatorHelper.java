...
public abstract class AirInFlowRateActuatorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(AirInFlowRateActuatorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/environment/AirInFlowRateActuator:1.0", "AirInFlowRateActuator");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.actuator.environment._AirInFlowRateActuatorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.actuator.environment.AirInFlowRateActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.actuator.environment.AirInFlowRateActuator)
		{
			return (com.traclabs.biosim.idl.actuator.environment.AirInFlowRateActuator)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/environment/AirInFlowRateActuator:1.0"))
		{
