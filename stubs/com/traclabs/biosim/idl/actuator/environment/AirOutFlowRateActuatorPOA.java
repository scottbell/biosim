	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.environment.AirOutFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", Integer.valueOf(14));
	...
	public com.traclabs.biosim.idl.actuator.environment.AirOutFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.environment.AirOutFlowRateActuator __r = com.traclabs.biosim.idl.actuator.environment.AirOutFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult217 = getModuleName();
_out.write_string( tmpResult217 );
				break;
			}
