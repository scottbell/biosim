	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.crew.CrewGroupActuatorOperations
{
	...
	public com.traclabs.biosim.idl.actuator.crew.CrewGroupActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.crew.CrewGroupActuator __r = com.traclabs.biosim.idl.actuator.crew.CrewGroupActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult213 = getModuleName();
_out.write_string( tmpResult213 );
				break;
			}
