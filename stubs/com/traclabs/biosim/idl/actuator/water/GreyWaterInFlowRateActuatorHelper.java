...
public abstract class GreyWaterInFlowRateActuatorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(GreyWaterInFlowRateActuatorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/water/GreyWaterInFlowRateActuator:1.0", "GreyWaterInFlowRateActuator");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.actuator.water._GreyWaterInFlowRateActuatorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuator)
		{
			return (com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuator)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/water/GreyWaterInFlowRateActuator:1.0"))
		{
