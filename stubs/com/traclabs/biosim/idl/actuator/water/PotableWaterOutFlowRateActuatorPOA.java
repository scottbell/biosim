	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.PotableWaterOutFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", Integer.valueOf(30));
	}
	...
	public com.traclabs.biosim.idl.actuator.water.PotableWaterOutFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.water.PotableWaterOutFlowRateActuator __r = com.traclabs.biosim.idl.actuator.water.PotableWaterOutFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult234 = getModuleName();
_out.write_string( tmpResult234 );
				break;
			}
