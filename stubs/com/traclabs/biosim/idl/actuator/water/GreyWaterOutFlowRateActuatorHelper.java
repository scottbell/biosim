...
public abstract class GreyWaterOutFlowRateActuatorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(GreyWaterOutFlowRateActuatorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/water/GreyWaterOutFlowRateActuator:1.0", "GreyWaterOutFlowRateActuator");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.actuator.water._GreyWaterOutFlowRateActuatorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuator)
		{
			return (com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuator)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/water/GreyWaterOutFlowRateActuator:1.0"))
		{
