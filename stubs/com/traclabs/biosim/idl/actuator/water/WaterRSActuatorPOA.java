	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.WaterRSActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "isFailureEnabled", Integer.valueOf(22));
		...
		m_opsHash.put ( "setOutput", Integer.valueOf(29));
	}
	...
	public com.traclabs.biosim.idl.actuator.water.WaterRSActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.water.WaterRSActuator __r = com.traclabs.biosim.idl.actuator.water.WaterRSActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult232 = getModuleName();
_out.write_string( tmpResult232 );
				break;
			}
