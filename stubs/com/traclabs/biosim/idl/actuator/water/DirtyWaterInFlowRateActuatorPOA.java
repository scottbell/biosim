	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuatorOperations
{
	...
	public com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuator __r = com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult237 = getModuleName();
_out.write_string( tmpResult237 );
				break;
			}
