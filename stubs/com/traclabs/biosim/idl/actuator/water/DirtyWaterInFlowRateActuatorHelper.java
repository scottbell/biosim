...
public abstract class DirtyWaterInFlowRateActuatorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(DirtyWaterInFlowRateActuatorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/water/DirtyWaterInFlowRateActuator:1.0", "DirtyWaterInFlowRateActuator");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.actuator.water._DirtyWaterInFlowRateActuatorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuator)
		{
			return (com.traclabs.biosim.idl.actuator.water.DirtyWaterInFlowRateActuator)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/water/DirtyWaterInFlowRateActuator:1.0"))
		{
