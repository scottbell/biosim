...
public abstract class WaterOutFlowRateActuatorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(WaterOutFlowRateActuatorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/water/WaterOutFlowRateActuator:1.0", "WaterOutFlowRateActuator");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.actuator.water._WaterOutFlowRateActuatorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.actuator.water.WaterOutFlowRateActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.actuator.water.WaterOutFlowRateActuator)
		{
			return (com.traclabs.biosim.idl.actuator.water.WaterOutFlowRateActuator)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/water/WaterOutFlowRateActuator:1.0"))
		{
