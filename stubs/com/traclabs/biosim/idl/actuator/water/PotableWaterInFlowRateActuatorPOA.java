	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.PotableWaterInFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", Integer.valueOf(3));
	...
	public com.traclabs.biosim.idl.actuator.water.PotableWaterInFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.water.PotableWaterInFlowRateActuator __r = com.traclabs.biosim.idl.actuator.water.PotableWaterInFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult233 = getModuleName();
_out.write_string( tmpResult233 );
				break;
			}
