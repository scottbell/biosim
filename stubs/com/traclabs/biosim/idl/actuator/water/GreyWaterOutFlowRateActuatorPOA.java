	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", Integer.valueOf(17));
		...
		m_opsHash.put ( "setValue", Integer.valueOf(22));
	...
	public com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuator __r = com.traclabs.biosim.idl.actuator.water.GreyWaterOutFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult236 = getModuleName();
_out.write_string( tmpResult236 );
				break;
			}
