	...
	public com.traclabs.biosim.idl.simulation.water.PotableWaterConsumer getOutput()
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			PotableWaterInFlowRateActuatorOperations _localServant = (PotableWaterInFlowRateActuatorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.water.PotableWaterConsumer _result;
			try
			{
	...
	public com.traclabs.biosim.idl.framework.BioModule getOutputModule()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getOutputModule", true);
					_is = _invoke(_os);
