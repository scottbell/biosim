...
public abstract class WaterInFlowRateActuatorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(WaterInFlowRateActuatorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/actuator/water/WaterInFlowRateActuator:1.0", "WaterInFlowRateActuator");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.actuator.water._WaterInFlowRateActuatorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.actuator.water.WaterInFlowRateActuator narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.actuator.water.WaterInFlowRateActuator)
		{
			return (com.traclabs.biosim.idl.actuator.water.WaterInFlowRateActuator)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/actuator/water/WaterInFlowRateActuator:1.0"))
		{
