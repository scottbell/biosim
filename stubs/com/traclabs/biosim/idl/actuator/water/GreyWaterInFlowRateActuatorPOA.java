	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", Integer.valueOf(4));
	...
	public com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuator __r = com.traclabs.biosim.idl.actuator.water.GreyWaterInFlowRateActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult235 = getModuleName();
_out.write_string( tmpResult235 );
				break;
			}
