	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.framework.InfluentValveActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setOutput", Integer.valueOf(18));
	...
	public com.traclabs.biosim.idl.actuator.framework.InfluentValveActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.framework.InfluentValveActuator __r = com.traclabs.biosim.idl.actuator.framework.InfluentValveActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult200 = getModuleName();
_out.write_string( tmpResult200 );
				break;
			}
