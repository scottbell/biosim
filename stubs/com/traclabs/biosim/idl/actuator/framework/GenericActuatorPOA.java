	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.actuator.framework.GenericActuatorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setValue", Integer.valueOf(20));
		m_opsHash.put ( "isFailureEnabled", Integer.valueOf(21));
		m_opsHash.put ( "startMalfunction", Integer.valueOf(22));
		m_opsHash.put ( "log", Integer.valueOf(23));
		m_opsHash.put ( "getMin", Integer.valueOf(24));
		m_opsHash.put ( "getOutputModule", Integer.valueOf(25));
	...
	public com.traclabs.biosim.idl.actuator.framework.GenericActuator _this()
	{
		...
		com.traclabs.biosim.idl.actuator.framework.GenericActuator __r = com.traclabs.biosim.idl.actuator.framework.GenericActuatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult199 = getModuleName();
_out.write_string( tmpResult199 );
				break;
			}
			case 16: // tick
			{
