	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.VCCROperations
{
	...
	public com.traclabs.biosim.idl.simulation.air.VCCR _this()
	{
		...
		com.traclabs.biosim.idl.simulation.air.VCCR __r = com.traclabs.biosim.idl.simulation.air.VCCRHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult95 = getModuleName();
_out.write_string( tmpResult95 );
				break;
			}
