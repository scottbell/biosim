	...
	implements com.traclabs.biosim.idl.simulation.air.H2Store
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/H2Store:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/PassiveModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Store:1.0"};
	public String[] _ids()
	{
		return ids;
	}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult98 = commandName;
