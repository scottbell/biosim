...
public abstract class O2StoreHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(O2StoreHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/air/O2Store:1.0", "O2Store");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.air._O2StoreStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.air.O2Store narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.air.O2Store)
		{
			return (com.traclabs.biosim.idl.simulation.air.O2Store)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/air/O2Store:1.0"))
		{
