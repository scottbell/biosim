...
public abstract class CRSHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(CRSHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/air/CRS:1.0", "CRS");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.air._CRSStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.air.CRS narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.air.CRS)
		{
			return (com.traclabs.biosim.idl.simulation.air.CRS)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/air/CRS:1.0"))
		{
