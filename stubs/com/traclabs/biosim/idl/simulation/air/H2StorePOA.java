	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.H2StoreOperations
{
	...
	public com.traclabs.biosim.idl.simulation.air.H2Store _this()
	{
		...
		com.traclabs.biosim.idl.simulation.air.H2Store __r = com.traclabs.biosim.idl.simulation.air.H2StoreHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult99 = getModuleName();
