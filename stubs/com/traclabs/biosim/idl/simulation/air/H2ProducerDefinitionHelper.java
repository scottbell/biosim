...
public abstract class H2ProducerDefinitionHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(H2ProducerDefinitionHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/air/H2ProducerDefinition:1.0", "H2ProducerDefinition");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.air._H2ProducerDefinitionStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.air.H2ProducerDefinition narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.air.H2ProducerDefinition)
		{
			return (com.traclabs.biosim.idl.simulation.air.H2ProducerDefinition)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/air/H2ProducerDefinition:1.0"))
		{
