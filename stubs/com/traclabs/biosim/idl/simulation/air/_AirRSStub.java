		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult88 = commandName;
	...
	public com.traclabs.biosim.idl.simulation.air.H2ProducerDefinition getH2ProducerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getH2ProducerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			AirRSOperations _localServant = (AirRSOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.H2ProducerDefinition _result;
			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.H2ConsumerDefinition getH2ConsumerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getH2ConsumerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			AirRSOperations _localServant = (AirRSOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.H2ConsumerDefinition _result;
			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.MethaneProducerDefinition getMethaneProducerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getMethaneProducerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			AirRSOperations _localServant = (AirRSOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.MethaneProducerDefinition _result;
			try
			{
