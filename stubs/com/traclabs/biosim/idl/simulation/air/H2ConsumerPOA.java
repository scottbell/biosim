	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.H2ConsumerOperations
{
	...
	public com.traclabs.biosim.idl.simulation.air.H2Consumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.air.H2Consumer __r = com.traclabs.biosim.idl.simulation.air.H2ConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult110 = getModuleName();
