	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.NitrogenStoreOperations
{
	...
	public com.traclabs.biosim.idl.simulation.air.NitrogenStore _this()
	{
		...
		com.traclabs.biosim.idl.simulation.air.NitrogenStore __r = com.traclabs.biosim.idl.simulation.air.NitrogenStoreHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult105 = getModuleName();
_out.write_string( tmpResult105 );
				break;
			}
