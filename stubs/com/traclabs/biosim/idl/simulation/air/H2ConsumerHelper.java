...
public abstract class H2ConsumerHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(H2ConsumerHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/air/H2Consumer:1.0", "H2Consumer");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.air._H2ConsumerStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.air.H2Consumer narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.air.H2Consumer)
		{
			return (com.traclabs.biosim.idl.simulation.air.H2Consumer)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/air/H2Consumer:1.0"))
		{
