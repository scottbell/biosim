	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.H2ProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getH2ProducerDefinition", Integer.valueOf(12));
	...
	public com.traclabs.biosim.idl.simulation.air.H2Producer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.air.H2Producer __r = com.traclabs.biosim.idl.simulation.air.H2ProducerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult111 = getModuleName();
