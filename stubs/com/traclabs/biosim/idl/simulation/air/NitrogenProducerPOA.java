	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.NitrogenProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getNitrogenProducerDefinition", Integer.valueOf(10));
	...
	public com.traclabs.biosim.idl.simulation.air.NitrogenProducer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.air.NitrogenProducer __r = com.traclabs.biosim.idl.simulation.air.NitrogenProducerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult115 = getModuleName();
_out.write_string( tmpResult115 );
				break;
			}
