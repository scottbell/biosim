	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.O2ConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getO2ConsumerDefinition", Integer.valueOf(19));
	...
	public com.traclabs.biosim.idl.simulation.air.O2Consumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.air.O2Consumer __r = com.traclabs.biosim.idl.simulation.air.O2ConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult108 = getModuleName();
