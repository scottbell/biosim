	...
	public com.traclabs.biosim.idl.simulation.air.MethaneConsumerDefinition getMethaneConsumerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getMethaneConsumerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			com.traclabs.biosim.idl.simulation.air.MethaneConsumerDefinition _result;
			try
			{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult90 = commandName;
