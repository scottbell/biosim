	...
	implements com.traclabs.biosim.idl.simulation.air.O2Store
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/air/O2Store:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/PassiveModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Store:1.0"};
	public String[] _ids()
	{
		return ids;
	}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult100 = commandName;
