	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.O2ProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getO2ProducerDefinition", Integer.valueOf(3));
	...
	public com.traclabs.biosim.idl.simulation.air.O2Producer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.air.O2Producer __r = com.traclabs.biosim.idl.simulation.air.O2ProducerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult109 = getModuleName();
