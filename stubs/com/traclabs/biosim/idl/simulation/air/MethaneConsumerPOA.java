	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.MethaneConsumerOperations
{
	...
	public com.traclabs.biosim.idl.simulation.air.MethaneConsumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.air.MethaneConsumer __r = com.traclabs.biosim.idl.simulation.air.MethaneConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult116 = getModuleName();
_out.write_string( tmpResult116 );
				break;
			}
