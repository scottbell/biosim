	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.CO2ProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getCO2ProducerDefinition", Integer.valueOf(21));
	...
	public com.traclabs.biosim.idl.simulation.air.CO2Producer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.air.CO2Producer __r = com.traclabs.biosim.idl.simulation.air.CO2ProducerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult113 = getModuleName();
