	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.air.NitrogenConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getNitrogenConsumerDefinition", Integer.valueOf(1));
	...
	public com.traclabs.biosim.idl.simulation.air.NitrogenConsumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.air.NitrogenConsumer __r = com.traclabs.biosim.idl.simulation.air.NitrogenConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult114 = getModuleName();
