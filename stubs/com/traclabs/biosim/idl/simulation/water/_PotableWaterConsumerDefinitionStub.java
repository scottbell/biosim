	...
	implements com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerDefinition
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/PotableWaterConsumerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/water/WaterConsumerDefinition:1.0"};
	public String[] _ids()
	{
		return ids;
	}
	...
	public void setPotableWaterInputs(com.traclabs.biosim.idl.simulation.water.PotableWaterStore[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setPotableWaterInputs", true);
