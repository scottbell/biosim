	...
	implements com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerDefinition
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/DirtyWaterConsumerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/water/WaterConsumerDefinition:1.0"};
	public String[] _ids()
	{
		return ids;
	}
	...
	public void setDirtyWaterInputs(com.traclabs.biosim.idl.simulation.water.DirtyWaterStore[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setDirtyWaterInputs", true);
