	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.GreyWaterStoreOperations
{
	...
	public com.traclabs.biosim.idl.simulation.water.GreyWaterStore _this()
	{
		...
		com.traclabs.biosim.idl.simulation.water.GreyWaterStore __r = com.traclabs.biosim.idl.simulation.water.GreyWaterStoreHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult127 = getModuleName();
