	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.GreyWaterProducerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setGreyWaterOutputs", Integer.valueOf(3));
		m_opsHash.put ( "getActualFlowRates", Integer.valueOf(4));
	...
	public com.traclabs.biosim.idl.simulation.water.GreyWaterProducerDefinition _this()
	{
		...
		com.traclabs.biosim.idl.simulation.water.GreyWaterProducerDefinition __r = com.traclabs.biosim.idl.simulation.water.GreyWaterProducerDefinitionHelper.narrow(__o);
		return __r;
	}
