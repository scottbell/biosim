...
public abstract class WaterConsumerDefinitionHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(WaterConsumerDefinitionHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/water/WaterConsumerDefinition:1.0", "WaterConsumerDefinition");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.water._WaterConsumerDefinitionStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.water.WaterConsumerDefinition narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.water.WaterConsumerDefinition)
		{
			return (com.traclabs.biosim.idl.simulation.water.WaterConsumerDefinition)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/water/WaterConsumerDefinition:1.0"))
		{
