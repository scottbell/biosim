	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.WaterStoreOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "scheduleMalfunction", Integer.valueOf(39));
		m_opsHash.put ( "getMalfunctionNames", Integer.valueOf(40));
		m_opsHash.put ( "isFailureEnabled", Integer.valueOf(41));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/WaterStore:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/PassiveModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Store:1.0"};
	public com.traclabs.biosim.idl.simulation.water.WaterStore _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		com.traclabs.biosim.idl.simulation.water.WaterStore __r = com.traclabs.biosim.idl.simulation.water.WaterStoreHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult123 = getModuleName();
