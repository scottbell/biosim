	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "connectsTo", Integer.valueOf(15));
		m_opsHash.put ( "getTotalMaxFlowRate", Integer.valueOf(16));
		m_opsHash.put ( "getDesiredFlowRates", Integer.valueOf(17));
		m_opsHash.put ( "setDirtyWaterInputs", Integer.valueOf(18));
	...
	public com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerDefinition _this()
	{
		...
		com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerDefinition __r = com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerDefinitionHelper.narrow(__o);
		return __r;
	}
