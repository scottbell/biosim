...
public abstract class GreyWaterConsumerHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(GreyWaterConsumerHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/water/GreyWaterConsumer:1.0", "GreyWaterConsumer");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.water._GreyWaterConsumerStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.water.GreyWaterConsumer narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.water.GreyWaterConsumer)
		{
			return (com.traclabs.biosim.idl.simulation.water.GreyWaterConsumer)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/water/GreyWaterConsumer:1.0"))
		{
