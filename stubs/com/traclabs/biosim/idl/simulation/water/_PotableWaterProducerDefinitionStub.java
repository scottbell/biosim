	...
	implements com.traclabs.biosim.idl.simulation.water.PotableWaterProducerDefinition
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/PotableWaterProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/water/WaterProducerDefinition:1.0"};
	public String[] _ids()
	{
		return ids;
	}
	...
	public float getPercentageFull(int index)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getPercentageFull", true);
	...
	public void setInitialStores(com.traclabs.biosim.idl.simulation.framework.Store[] pStores)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setInitialStores", true);
	...
	public float[] getActualFlowRates()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getActualFlowRates", true);
					_is = _invoke(_os);
	...
	public float[] getMaxFlowRates()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getMaxFlowRates", true);
					_is = _invoke(_os);
					float[] _result = com.traclabs.biosim.idl.FloatListHelper.read(_is);
					return _result;
				}
	...
	public void setInitialDesiredFlowRates(float[] flowrates)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setInitialDesiredFlowRates", true);
	...
	public void setDesiredFlowRate(float value, int index)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setDesiredFlowRate", true);
	...
	public float getTotalActualFlowRate()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getTotalActualFlowRate", true);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
				}
	...
	public void setInitialActualFlowRates(float[] flowrates)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setInitialActualFlowRates", true);
					com.traclabs.biosim.idl.FloatListHelper.write(_os,flowrates);
					_is = _invoke(_os);
					return;
				}
	...
	public float getActualFlowRate(int index)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getActualFlowRate", true);
					_os.write_long(index);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
	...
	public void setInitialMaxFlowRates(float[] flowrates)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setInitialMaxFlowRates", true);
					com.traclabs.biosim.idl.FloatListHelper.write(_os,flowrates);
					_is = _invoke(_os);
					return;
				}
	...
	public float getMaxFlowRate(int index)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getMaxFlowRate", true);
					_os.write_long(index);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
	...
	public float getAveragePercentageFull()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAveragePercentageFull", true);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
				}
	...
	public void setPotableWaterOutputs(com.traclabs.biosim.idl.simulation.water.PotableWaterStore[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setPotableWaterOutputs", true);
	...
	public float getTotalMaxFlowRate()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getTotalMaxFlowRate", true);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
				}
	...
	public float[] getDesiredFlowRates()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getDesiredFlowRates", true);
					_is = _invoke(_os);
					float[] _result = com.traclabs.biosim.idl.FloatListHelper.read(_is);
					return _result;
				}
	...
	public void setMaxFlowRate(float value, int index)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setMaxFlowRate", true);
					_os.write_float(value);
					_os.write_long(index);
					_is = _invoke(_os);
					return;
	...
	public float getDesiredFlowRate(int index)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getDesiredFlowRate", true);
					_os.write_long(index);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
	...
	public float getTotalDesiredFlowRate()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getTotalDesiredFlowRate", true);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
				}
