	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getDirtyWaterConsumerDefinition", Integer.valueOf(10));
	...
	public com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumer __r = com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult133 = getModuleName();
