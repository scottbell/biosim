	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.WaterConsumerOperations
{
	...
	public com.traclabs.biosim.idl.simulation.water.WaterConsumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.water.WaterConsumer __r = com.traclabs.biosim.idl.simulation.water.WaterConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult130 = getModuleName();
_out.write_string( tmpResult130 );
				break;
			}
