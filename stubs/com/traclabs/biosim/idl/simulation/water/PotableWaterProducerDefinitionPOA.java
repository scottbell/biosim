	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.PotableWaterProducerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getMaxFlowRate", Integer.valueOf(13));
		m_opsHash.put ( "getAveragePercentageFull", Integer.valueOf(14));
		m_opsHash.put ( "setPotableWaterOutputs", Integer.valueOf(15));
		m_opsHash.put ( "connectsTo", Integer.valueOf(16));
		m_opsHash.put ( "getTotalMaxFlowRate", Integer.valueOf(17));
		m_opsHash.put ( "getDesiredFlowRates", Integer.valueOf(18));
	...
	public com.traclabs.biosim.idl.simulation.water.PotableWaterProducerDefinition _this()
	{
		...
		com.traclabs.biosim.idl.simulation.water.PotableWaterProducerDefinition __r = com.traclabs.biosim.idl.simulation.water.PotableWaterProducerDefinitionHelper.narrow(__o);
		return __r;
	}
