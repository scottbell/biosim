	...
	implements com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerDefinition
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/DirtyWaterProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/water/WaterProducerDefinition:1.0"};
	public String[] _ids()
	{
		return ids;
	}
	...
	public void setDirtyWaterOutputs(com.traclabs.biosim.idl.simulation.water.DirtyWaterStore[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setDirtyWaterOutputs", true);
