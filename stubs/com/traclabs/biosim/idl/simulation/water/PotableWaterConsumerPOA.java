	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerOperations
{
	...
	public com.traclabs.biosim.idl.simulation.water.PotableWaterConsumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.water.PotableWaterConsumer __r = com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult131 = getModuleName();
_out.write_string( tmpResult131 );
				break;
			}
