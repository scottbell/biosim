	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.PotableWaterProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getPotableWaterProducerDefinition", Integer.valueOf(19));
	...
	public com.traclabs.biosim.idl.simulation.water.PotableWaterProducer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.water.PotableWaterProducer __r = com.traclabs.biosim.idl.simulation.water.PotableWaterProducerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult135 = getModuleName();
