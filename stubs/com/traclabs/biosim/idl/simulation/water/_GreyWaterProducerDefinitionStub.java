	...
	implements com.traclabs.biosim.idl.simulation.water.GreyWaterProducerDefinition
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/GreyWaterProducerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/water/WaterProducerDefinition:1.0"};
	public String[] _ids()
	{
		return ids;
	}
	...
	public void setGreyWaterOutputs(com.traclabs.biosim.idl.simulation.water.GreyWaterStore[] destinations, float[] maxFlowRates, float[] desiredFlowRates)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setGreyWaterOutputs", true);
