	...
	implements com.traclabs.biosim.idl.simulation.water.GreyWaterConsumerDefinition
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/GreyWaterConsumerDefinition:1.0","IDL:com/traclabs/biosim/idl/simulation/water/WaterConsumerDefinition:1.0"};
	public String[] _ids()
	{
		return ids;
	}
	...
	public void setGreyWaterInputs(com.traclabs.biosim.idl.simulation.water.GreyWaterStore[] sources, float[] maxFlowRates, float[] desiredFlowRates)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setGreyWaterInputs", true);
