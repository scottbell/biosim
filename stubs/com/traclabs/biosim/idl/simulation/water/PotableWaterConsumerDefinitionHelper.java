...
public abstract class PotableWaterConsumerDefinitionHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(PotableWaterConsumerDefinitionHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/water/PotableWaterConsumerDefinition:1.0", "PotableWaterConsumerDefinition");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.water._PotableWaterConsumerDefinitionStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerDefinition narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerDefinition)
		{
			return (com.traclabs.biosim.idl.simulation.water.PotableWaterConsumerDefinition)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/water/PotableWaterConsumerDefinition:1.0"))
		{
