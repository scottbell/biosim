	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.DirtyWaterStoreOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getCurrentTemperature", Integer.valueOf(29));
		m_opsHash.put ( "add", Integer.valueOf(30));
		m_opsHash.put ( "addWaterWithTemperature", Integer.valueOf(31));
		m_opsHash.put ( "setInitialWaterTemperature", Integer.valueOf(32));
		...
		m_opsHash.put ( "clearAllMalfunctions", Integer.valueOf(36));
		m_opsHash.put ( "tick", Integer.valueOf(37));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/water/DirtyWaterStore:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/PassiveModule:1.0","IDL:com/traclabs/biosim/idl/simulation/water/WaterStore:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Store:1.0"};
	public com.traclabs.biosim.idl.simulation.water.DirtyWaterStore _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		com.traclabs.biosim.idl.simulation.water.DirtyWaterStore __r = com.traclabs.biosim.idl.simulation.water.DirtyWaterStoreHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult129 = getModuleName();
_out.write_string( tmpResult129 );
				break;
			}
