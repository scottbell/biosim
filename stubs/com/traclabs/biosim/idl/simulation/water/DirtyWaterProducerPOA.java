	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getDirtyWaterProducerDefinition", Integer.valueOf(20));
	...
	public com.traclabs.biosim.idl.simulation.water.DirtyWaterProducer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.water.DirtyWaterProducer __r = com.traclabs.biosim.idl.simulation.water.DirtyWaterProducerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult137 = getModuleName();
_out.write_string( tmpResult137 );
				break;
			}
