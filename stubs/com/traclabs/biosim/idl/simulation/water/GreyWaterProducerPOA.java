	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.water.GreyWaterProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getGreyWaterProducerDefinition", Integer.valueOf(3));
		m_opsHash.put ( "isMalfunctioning", Integer.valueOf(4));
		m_opsHash.put ( "clearAllMalfunctions", Integer.valueOf(5));
		m_opsHash.put ( "setEnableFailure", Integer.valueOf(6));
		m_opsHash.put ( "randomFilter", Integer.valueOf(7));
		m_opsHash.put ( "reset", Integer.valueOf(8));
		m_opsHash.put ( "getMyTicks", Integer.valueOf(9));
		m_opsHash.put ( "maintain", Integer.valueOf(10));
		m_opsHash.put ( "doSomeRepairWork", Integer.valueOf(11));
		m_opsHash.put ( "getID", Integer.valueOf(12));
		m_opsHash.put ( "getModuleName", Integer.valueOf(13));
		m_opsHash.put ( "scheduleMalfunction", Integer.valueOf(14));
		m_opsHash.put ( "tick", Integer.valueOf(15));
		m_opsHash.put ( "fixMalfunction", Integer.valueOf(16));
		m_opsHash.put ( "getMalfunctionNames", Integer.valueOf(17));
		m_opsHash.put ( "setTickLength", Integer.valueOf(18));
		m_opsHash.put ( "isFailureEnabled", Integer.valueOf(19));
		m_opsHash.put ( "startMalfunction", Integer.valueOf(20));
		m_opsHash.put ( "log", Integer.valueOf(21));
		m_opsHash.put ( "getMalfunctions", Integer.valueOf(22));
		m_opsHash.put ( "fixAllMalfunctions", Integer.valueOf(23));
	}
	...
	public com.traclabs.biosim.idl.simulation.water.GreyWaterProducer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.water.GreyWaterProducer __r = com.traclabs.biosim.idl.simulation.water.GreyWaterProducerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult136 = getModuleName();
_out.write_string( tmpResult136 );
				break;
			}
