	...
	public void setStartTick(int tick)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setStartTick", true);
					_os.write_long(tick);
					_is = _invoke(_os);
					return;
				}
	...
	public com.traclabs.biosim.idl.simulation.food.Plant getPlant()
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			ShelfOperations _localServant = (ShelfOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.Plant _result;
			try
			{
	...
	public com.traclabs.biosim.idl.simulation.food.BiomassPS getBiomassPS()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getBiomassPS", true);
					_is = _invoke(_os);
	...
	public float getHarvestInterval()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getHarvestInterval", true);
					_is = _invoke(_os);
	...
	public java.lang.String getCropTypeString()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getCropTypeString", true);
					_is = _invoke(_os);
	...
	public com.traclabs.biosim.idl.simulation.food.PlantType getCropType()
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			ShelfOperations _localServant = (ShelfOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.PlantType _result;
			try
			{
	...
	public boolean isReadyForHavest()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "isReadyForHavest", true);
					_is = _invoke(_os);
					boolean _result = _is.read_boolean();
					return _result;
				}
	...
	public float getCropAreaUsed()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getCropAreaUsed", true);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
				}
	...
	public float getTimeTillCanopyClosure()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getTimeTillCanopyClosure", true);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
				}
	...
	public float getCropAreaTotal()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getCropAreaTotal", true);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
				}
