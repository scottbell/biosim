	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.BiomassProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getBiomassProducerDefinition", Integer.valueOf(14));
	...
	public com.traclabs.biosim.idl.simulation.food.BiomassProducer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.food.BiomassProducer __r = com.traclabs.biosim.idl.simulation.food.BiomassProducerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult76 = getModuleName();
_out.write_string( tmpResult76 );
				break;
			}
