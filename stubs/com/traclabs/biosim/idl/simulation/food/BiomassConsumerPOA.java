	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.BiomassConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getBiomassConsumerDefinition", Integer.valueOf(15));
	...
	public com.traclabs.biosim.idl.simulation.food.BiomassConsumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.food.BiomassConsumer __r = com.traclabs.biosim.idl.simulation.food.BiomassConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult74 = getModuleName();
_out.write_string( tmpResult74 );
				break;
			}
