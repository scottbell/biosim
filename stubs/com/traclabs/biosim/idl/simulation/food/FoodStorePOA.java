	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.FoodStoreOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "takeFoodMatterCalories", Integer.valueOf(12));
		...
		m_opsHash.put ( "addFoodMatterArray", Integer.valueOf(16));
		...
		m_opsHash.put ( "addFoodMatterMass", Integer.valueOf(30));
		m_opsHash.put ( "doSomeRepairWork", Integer.valueOf(31));
		m_opsHash.put ( "add", Integer.valueOf(32));
		m_opsHash.put ( "isPipe", Integer.valueOf(33));
		m_opsHash.put ( "clearAllMalfunctions", Integer.valueOf(34));
		m_opsHash.put ( "setEnableFailure", Integer.valueOf(35));
		m_opsHash.put ( "getInitialLevel", Integer.valueOf(36));
		m_opsHash.put ( "setInitialFoodMatterLevel", Integer.valueOf(37));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/food/FoodStore:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/PassiveModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Store:1.0"};
	public com.traclabs.biosim.idl.simulation.food.FoodStore _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		com.traclabs.biosim.idl.simulation.food.FoodStore __r = com.traclabs.biosim.idl.simulation.food.FoodStoreHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult70 = getModuleName();
_out.write_string( tmpResult70 );
				break;
			}
