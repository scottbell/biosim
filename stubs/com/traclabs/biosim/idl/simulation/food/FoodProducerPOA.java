	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.FoodProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getFoodProducerDefinition", Integer.valueOf(10));
	...
	public com.traclabs.biosim.idl.simulation.food.FoodProducer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.food.FoodProducer __r = com.traclabs.biosim.idl.simulation.food.FoodProducerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult77 = getModuleName();
