...
public abstract class FoodProducerHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(FoodProducerHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/food/FoodProducer:1.0", "FoodProducer");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.food._FoodProducerStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.food.FoodProducer narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.food.FoodProducer)
		{
			return (com.traclabs.biosim.idl.simulation.food.FoodProducer)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/food/FoodProducer:1.0"))
		{
