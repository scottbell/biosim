...
public abstract class BiomassPSHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(BiomassPSHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/food/BiomassPS:1.0", "BiomassPS");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.food._BiomassPSStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.food.BiomassPS narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.food.BiomassPS)
		{
			return (com.traclabs.biosim.idl.simulation.food.BiomassPS)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/food/BiomassPS:1.0"))
		{
