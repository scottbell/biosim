	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.food.FoodConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getFoodConsumerDefinition", Integer.valueOf(10));
	...
	public com.traclabs.biosim.idl.simulation.food.FoodConsumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.food.FoodConsumer __r = com.traclabs.biosim.idl.simulation.food.FoodConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult75 = getModuleName();
_out.write_string( tmpResult75 );
				break;
			}
