	...
	implements com.traclabs.biosim.idl.simulation.waste.DryWasteStore
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/waste/DryWasteStore:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/PassiveModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Store:1.0"};
	public String[] _ids()
	{
		return ids;
	}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult140 = commandName;
