	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.waste.DryWasteStoreOperations
{
	...
	public com.traclabs.biosim.idl.simulation.waste.DryWasteStore _this()
	{
		...
		com.traclabs.biosim.idl.simulation.waste.DryWasteStore __r = com.traclabs.biosim.idl.simulation.waste.DryWasteStoreHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult141 = getModuleName();
