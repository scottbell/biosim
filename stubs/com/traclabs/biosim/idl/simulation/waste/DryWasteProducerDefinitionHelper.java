...
public abstract class DryWasteProducerDefinitionHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(DryWasteProducerDefinitionHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/waste/DryWasteProducerDefinition:1.0", "DryWasteProducerDefinition");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.waste._DryWasteProducerDefinitionStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.waste.DryWasteProducerDefinition narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.waste.DryWasteProducerDefinition)
		{
			return (com.traclabs.biosim.idl.simulation.waste.DryWasteProducerDefinition)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/waste/DryWasteProducerDefinition:1.0"))
		{
