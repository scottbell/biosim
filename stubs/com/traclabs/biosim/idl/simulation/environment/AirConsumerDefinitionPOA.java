	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.AirConsumerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setAirInputs", Integer.valueOf(1));
		m_opsHash.put ( "getActualFlowRates", Integer.valueOf(2));
		m_opsHash.put ( "getMaxFlowRates", Integer.valueOf(3));
		m_opsHash.put ( "reset", Integer.valueOf(4));
		m_opsHash.put ( "setInitialDesiredFlowRates", Integer.valueOf(5));
	...
	public com.traclabs.biosim.idl.simulation.environment.AirConsumerDefinition _this()
	{
		...
		com.traclabs.biosim.idl.simulation.environment.AirConsumerDefinition __r = com.traclabs.biosim.idl.simulation.environment.AirConsumerDefinitionHelper.narrow(__o);
		return __r;
	}
