	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.DehumidifierOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getAirConsumerDefinition", Integer.valueOf(7));
		...
		m_opsHash.put ( "tick", Integer.valueOf(17));
		m_opsHash.put ( "fixMalfunction", Integer.valueOf(18));
		m_opsHash.put ( "getMalfunctionNames", Integer.valueOf(19));
		m_opsHash.put ( "setTickLength", Integer.valueOf(20));
		m_opsHash.put ( "isFailureEnabled", Integer.valueOf(21));
		m_opsHash.put ( "getDirtyWaterProducerDefinition", Integer.valueOf(22));
		m_opsHash.put ( "startMalfunction", Integer.valueOf(23));
		m_opsHash.put ( "log", Integer.valueOf(24));
		m_opsHash.put ( "getMalfunctions", Integer.valueOf(25));
		m_opsHash.put ( "fixAllMalfunctions", Integer.valueOf(26));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/environment/Dehumidifier:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SimBioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/water/DirtyWaterProducer:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/AirConsumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.simulation.environment.Dehumidifier _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		com.traclabs.biosim.idl.simulation.environment.Dehumidifier __r = com.traclabs.biosim.idl.simulation.environment.DehumidifierHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult45 = getModuleName();
_out.write_string( tmpResult45 );
				break;
			}
