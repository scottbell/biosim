...
public abstract class LightConsumerDefinitionHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(LightConsumerDefinitionHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/environment/LightConsumerDefinition:1.0", "LightConsumerDefinition");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.environment._LightConsumerDefinitionStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.environment.LightConsumerDefinition narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.environment.LightConsumerDefinition)
		{
			return (com.traclabs.biosim.idl.simulation.environment.LightConsumerDefinition)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/environment/LightConsumerDefinition:1.0"))
		{
