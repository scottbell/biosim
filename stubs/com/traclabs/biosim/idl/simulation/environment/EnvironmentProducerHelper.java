...
public abstract class EnvironmentProducerHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(EnvironmentProducerHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentProducer:1.0", "EnvironmentProducer");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.environment._EnvironmentProducerStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.environment.EnvironmentProducer narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.environment.EnvironmentProducer)
		{
			return (com.traclabs.biosim.idl.simulation.environment.EnvironmentProducer)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentProducer:1.0"))
		{
