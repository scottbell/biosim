	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.StoreEnvironmentConsumerOperations
{
	...
	public com.traclabs.biosim.idl.simulation.environment.StoreEnvironmentConsumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.environment.StoreEnvironmentConsumer __r = com.traclabs.biosim.idl.simulation.environment.StoreEnvironmentConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult42 = getModuleName();
_out.write_string( tmpResult42 );
				break;
			}
