	...
	public float getInitialPressure()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getInitialPressure", true);
					_is = _invoke(_os);
	...
	public void setCurrentLevel(float metricAmount)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setCurrentLevel", true);
	...
	public float getCurrentCapacity()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getCurrentCapacity", true);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult56 = commandName;
	...
	public void setInitialCapacity(float metricAmount)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setInitialCapacity", true);
					_os.write_float(metricAmount);
					_is = _invoke(_os);
					return;
				}
	...
	public float getInitialCapacity()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getInitialCapacity", true);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
				}
	...
	public float getPercentageFilled()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getPercentageFilled", true);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
				}
	...
	public void setInitialLevel(float metricAmount)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setInitialLevel", true);
					_os.write_float(metricAmount);
					_is = _invoke(_os);
					return;
				}
	...
	public float getCurrentLevel()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getCurrentLevel", true);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
				}
	...
	public void setCurrentCapacity(float metricAmount)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setCurrentCapacity", true);
					_os.write_float(metricAmount);
					_is = _invoke(_os);
					return;
				}
	...
	public float getInitialLevel()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getInitialLevel", true);
					_is = _invoke(_os);
					float _result = _is.read_float();
					return _result;
				}
