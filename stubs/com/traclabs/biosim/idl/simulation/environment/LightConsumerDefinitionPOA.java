	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.LightConsumerDefinitionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setLightInput", Integer.valueOf(5));
	...
	public com.traclabs.biosim.idl.simulation.environment.LightConsumerDefinition _this()
	{
		...
		com.traclabs.biosim.idl.simulation.environment.LightConsumerDefinition __r = com.traclabs.biosim.idl.simulation.environment.LightConsumerDefinitionHelper.narrow(__o);
		return __r;
	}
