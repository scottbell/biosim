	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.EnvironmentVaporStoreOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setEnableFailure", Integer.valueOf(33));
		m_opsHash.put ( "getInitialLevel", Integer.valueOf(34));
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentVaporStore:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentStore:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/PassiveModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Store:1.0"};
	public com.traclabs.biosim.idl.simulation.environment.EnvironmentVaporStore _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		com.traclabs.biosim.idl.simulation.environment.EnvironmentVaporStore __r = com.traclabs.biosim.idl.simulation.environment.EnvironmentVaporStoreHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult59 = getModuleName();
_out.write_string( tmpResult59 );
				break;
			}
