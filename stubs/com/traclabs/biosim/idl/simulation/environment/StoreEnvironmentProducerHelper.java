...
public abstract class StoreEnvironmentProducerHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(StoreEnvironmentProducerHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/environment/StoreEnvironmentProducer:1.0", "StoreEnvironmentProducer");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.environment._StoreEnvironmentProducerStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.environment.StoreEnvironmentProducer narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.environment.StoreEnvironmentProducer)
		{
			return (com.traclabs.biosim.idl.simulation.environment.StoreEnvironmentProducer)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/environment/StoreEnvironmentProducer:1.0"))
		{
