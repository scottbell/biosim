	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.EnvironmentOtherStoreOperations
{
	...
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentOtherStore:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentStore:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/PassiveModule:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Store:1.0"};
	public com.traclabs.biosim.idl.simulation.environment.EnvironmentOtherStore _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		com.traclabs.biosim.idl.simulation.environment.EnvironmentOtherStore __r = com.traclabs.biosim.idl.simulation.environment.EnvironmentOtherStoreHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult61 = getModuleName();
_out.write_string( tmpResult61 );
				break;
			}
