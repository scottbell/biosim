...
public abstract class EnvironmentFlowRateControllableHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(EnvironmentFlowRateControllableHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentFlowRateControllable:1.0", "EnvironmentFlowRateControllable");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.environment._EnvironmentFlowRateControllableStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.environment.EnvironmentFlowRateControllable narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.environment.EnvironmentFlowRateControllable)
		{
			return (com.traclabs.biosim.idl.simulation.environment.EnvironmentFlowRateControllable)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentFlowRateControllable:1.0"))
		{
