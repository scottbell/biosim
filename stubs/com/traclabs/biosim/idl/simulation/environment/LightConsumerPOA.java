	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.LightConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getLightConsumerDefinition", Integer.valueOf(10));
	...
	public com.traclabs.biosim.idl.simulation.environment.LightConsumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.environment.LightConsumer __r = com.traclabs.biosim.idl.simulation.environment.LightConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult63 = getModuleName();
