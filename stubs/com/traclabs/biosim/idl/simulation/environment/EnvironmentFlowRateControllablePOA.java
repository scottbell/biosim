	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.EnvironmentFlowRateControllableOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setDesiredFlowRate", Integer.valueOf(5));
		m_opsHash.put ( "getTotalActualFlowRate", Integer.valueOf(6));
		m_opsHash.put ( "setInitialActualFlowRates", Integer.valueOf(7));
		m_opsHash.put ( "getActualFlowRate", Integer.valueOf(8));
		m_opsHash.put ( "setInitialMaxFlowRates", Integer.valueOf(9));
		m_opsHash.put ( "getMaxFlowRate", Integer.valueOf(10));
		m_opsHash.put ( "getAveragePercentageFull", Integer.valueOf(11));
		m_opsHash.put ( "connectsTo", Integer.valueOf(12));
		m_opsHash.put ( "getTotalMaxFlowRate", Integer.valueOf(13));
		m_opsHash.put ( "getDesiredFlowRates", Integer.valueOf(14));
		m_opsHash.put ( "setMaxFlowRate", Integer.valueOf(15));
		m_opsHash.put ( "getDesiredFlowRate", Integer.valueOf(16));
		m_opsHash.put ( "getEnvironments", Integer.valueOf(17));
		m_opsHash.put ( "getTotalDesiredFlowRate", Integer.valueOf(18));
	}
	...
	public com.traclabs.biosim.idl.simulation.environment.EnvironmentFlowRateControllable _this()
	{
		...
		com.traclabs.biosim.idl.simulation.environment.EnvironmentFlowRateControllable __r = com.traclabs.biosim.idl.simulation.environment.EnvironmentFlowRateControllableHelper.narrow(__o);
		return __r;
	}
