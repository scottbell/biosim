	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.AirConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getAirConsumerDefinition", Integer.valueOf(5));
		...
		m_opsHash.put ( "getMalfunctions", Integer.valueOf(23));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult62 = getModuleName();
_out.write_string( tmpResult62 );
				break;
			}
