	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.EnvironmentCO2StoreOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getInitialPressure", Integer.valueOf(1));
		m_opsHash.put ( "setCurrentLevel", Integer.valueOf(2));
		m_opsHash.put ( "clearMalfunction", Integer.valueOf(3));
		m_opsHash.put ( "getTickLength", Integer.valueOf(4));
		m_opsHash.put ( "fixAllMalfunctions", Integer.valueOf(5));
		m_opsHash.put ( "setLogLevel", Integer.valueOf(6));
		m_opsHash.put ( "startMalfunction", Integer.valueOf(7));
		m_opsHash.put ( "getCurrentCapacity", Integer.valueOf(8));
		m_opsHash.put ( "notifyCommandSent", Integer.valueOf(9));
		m_opsHash.put ( "getID", Integer.valueOf(10));
		m_opsHash.put ( "setInitialCapacity", Integer.valueOf(11));
		m_opsHash.put ( "fixMalfunction", Integer.valueOf(12));
		m_opsHash.put ( "getMyTicks", Integer.valueOf(13));
		m_opsHash.put ( "getMalfunctions", Integer.valueOf(14));
		m_opsHash.put ( "getInitialCapacity", Integer.valueOf(15));
		m_opsHash.put ( "reset", Integer.valueOf(16));
		m_opsHash.put ( "registerBioCommandListener", Integer.valueOf(17));
		m_opsHash.put ( "getOverflow", Integer.valueOf(18));
		m_opsHash.put ( "take", Integer.valueOf(19));
		m_opsHash.put ( "getPercentageFilled", Integer.valueOf(20));
		m_opsHash.put ( "getModuleName", Integer.valueOf(21));
		m_opsHash.put ( "randomFilter", Integer.valueOf(22));
		m_opsHash.put ( "isMalfunctioning", Integer.valueOf(23));
		m_opsHash.put ( "getPressure", Integer.valueOf(24));
		...
		m_opsHash.put ( "getCurrentLevel", Integer.valueOf(28));
		m_opsHash.put ( "setCurrentCapacity", Integer.valueOf(29));
		m_opsHash.put ( "doSomeRepairWork", Integer.valueOf(30));
		m_opsHash.put ( "add", Integer.valueOf(31));
		m_opsHash.put ( "isPipe", Integer.valueOf(32));
		m_opsHash.put ( "getInitialLevel", Integer.valueOf(33));
		m_opsHash.put ( "setEnableFailure", Integer.valueOf(34));
		...
		m_opsHash.put ( "getMalfunctionNames", Integer.valueOf(39));
		m_opsHash.put ( "scheduleMalfunction", Integer.valueOf(40));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentCO2Store:1.0","IDL:com/traclabs/biosim/idl/simulation/environment/EnvironmentStore:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/PassiveModule:1.0","IDL:com/traclabs/biosim/idl/simulation/air/CO2Store:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/Store:1.0"};
	public com.traclabs.biosim.idl.simulation.environment.EnvironmentCO2Store _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		com.traclabs.biosim.idl.simulation.environment.EnvironmentCO2Store __r = com.traclabs.biosim.idl.simulation.environment.EnvironmentCO2StoreHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult55 = getModuleName();
_out.write_string( tmpResult55 );
				break;
			}
