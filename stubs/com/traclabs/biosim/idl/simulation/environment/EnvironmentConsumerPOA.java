	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.EnvironmentConsumerOperations
{
	...
	public com.traclabs.biosim.idl.simulation.environment.EnvironmentConsumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.environment.EnvironmentConsumer __r = com.traclabs.biosim.idl.simulation.environment.EnvironmentConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult40 = getModuleName();
_out.write_string( tmpResult40 );
				break;
			}
