	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.environment.EnvironmentProducerOperations
{
	...
	public com.traclabs.biosim.idl.simulation.environment.EnvironmentProducer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.environment.EnvironmentProducer __r = com.traclabs.biosim.idl.simulation.environment.EnvironmentProducerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult41 = getModuleName();
_out.write_string( tmpResult41 );
				break;
			}
