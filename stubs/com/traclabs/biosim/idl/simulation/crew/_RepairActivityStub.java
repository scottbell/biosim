	...
	public java.lang.String getModuleNameToRepair()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getModuleNameToRepair", true);
					_is = _invoke(_os);
	...
	public long getMalfunctionIDToRepair()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getMalfunctionIDToRepair", true);
					_is = _invoke(_os);
	...
	public int getActivityIntensity()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getActivityIntensity", true);
					_is = _invoke(_os);
	...
	public int getTimeLength()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getTimeLength", true);
					_is = _invoke(_os);
					int _result = _is.read_long();
					return _result;
				}
