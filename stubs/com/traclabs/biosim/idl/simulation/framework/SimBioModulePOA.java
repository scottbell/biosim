	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.framework.SimBioModuleOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getMalfunctions", Integer.valueOf(24));
	}
	...
	public com.traclabs.biosim.idl.simulation.framework.SimBioModule _this()
	{
		...
		com.traclabs.biosim.idl.simulation.framework.SimBioModule __r = com.traclabs.biosim.idl.simulation.framework.SimBioModuleHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult12 = getModuleName();
