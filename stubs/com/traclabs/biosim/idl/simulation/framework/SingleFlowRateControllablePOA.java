	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.framework.SingleFlowRateControllableOperations
{
	...
	static
	{
		m_opsHash.put ( "setInitialActualFlowRates", Integer.valueOf(0));
		m_opsHash.put ( "getMaxFlowRate", Integer.valueOf(1));
		m_opsHash.put ( "getDesiredFlowRates", Integer.valueOf(2));
		m_opsHash.put ( "getActualFlowRates", Integer.valueOf(3));
		m_opsHash.put ( "setDesiredFlowRate", Integer.valueOf(4));
		m_opsHash.put ( "getTotalDesiredFlowRate", Integer.valueOf(5));
		m_opsHash.put ( "getMaxFlowRates", Integer.valueOf(6));
		m_opsHash.put ( "getTotalMaxFlowRate", Integer.valueOf(7));
		m_opsHash.put ( "getActualFlowRate", Integer.valueOf(8));
		m_opsHash.put ( "getTotalActualFlowRate", Integer.valueOf(9));
		m_opsHash.put ( "setMaxFlowRate", Integer.valueOf(10));
		m_opsHash.put ( "setInitialDesiredFlowRates", Integer.valueOf(11));
		m_opsHash.put ( "setInitialMaxFlowRates", Integer.valueOf(12));
		m_opsHash.put ( "getAveragePercentageFull", Integer.valueOf(13));
		m_opsHash.put ( "getPercentageFull", Integer.valueOf(14));
	...
	public com.traclabs.biosim.idl.simulation.framework.SingleFlowRateControllable _this()
	{
		...
		com.traclabs.biosim.idl.simulation.framework.SingleFlowRateControllable __r = com.traclabs.biosim.idl.simulation.framework.SingleFlowRateControllableHelper.narrow(__o);
		return __r;
	}
