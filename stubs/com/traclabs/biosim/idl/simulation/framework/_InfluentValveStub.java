	...
	public com.traclabs.biosim.idl.simulation.air.NitrogenProducerDefinition getNitrogenProducerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getNitrogenProducerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			InfluentValveOperations _localServant = (InfluentValveOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.NitrogenProducerDefinition _result;
			try
			{
	...
	public com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerDefinition getDirtyWaterConsumerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getDirtyWaterConsumerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			InfluentValveOperations _localServant = (InfluentValveOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.water.DirtyWaterConsumerDefinition _result;
			try
			{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult19 = commandName;
	...
	public com.traclabs.biosim.idl.simulation.food.FoodProducerDefinition getFoodProducerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getFoodProducerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			InfluentValveOperations _localServant = (InfluentValveOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.FoodProducerDefinition _result;
			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.NitrogenConsumerDefinition getNitrogenConsumerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getNitrogenConsumerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			InfluentValveOperations _localServant = (InfluentValveOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.NitrogenConsumerDefinition _result;
			try
			{
	...
	public int getIndexOfInfluentStore()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getIndexOfInfluentStore", true);
					_is = _invoke(_os);
					int _result = _is.read_long();
					return _result;
				}
	...
	public com.traclabs.biosim.idl.simulation.water.PotableWaterProducerDefinition getPotableWaterProducerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getPotableWaterProducerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			InfluentValveOperations _localServant = (InfluentValveOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.water.PotableWaterProducerDefinition _result;
			try
			{
	...
	public com.traclabs.biosim.idl.simulation.food.BiomassConsumerDefinition getBiomassConsumerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getBiomassConsumerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			InfluentValveOperations _localServant = (InfluentValveOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.food.BiomassConsumerDefinition _result;
			try
			{
	...
	public com.traclabs.biosim.idl.simulation.waste.DryWasteConsumerDefinition getDryWasteConsumerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getDryWasteConsumerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			InfluentValveOperations _localServant = (InfluentValveOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.waste.DryWasteConsumerDefinition _result;
			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.O2ProducerDefinition getO2ProducerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getO2ProducerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			InfluentValveOperations _localServant = (InfluentValveOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.O2ProducerDefinition _result;
			try
			{
	...
	public void setIndexOfInfluentStore(int pIndexOfEffluentStore)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setIndexOfInfluentStore", true);
	...
	public com.traclabs.biosim.idl.simulation.air.O2ConsumerDefinition getO2ConsumerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getO2ConsumerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			InfluentValveOperations _localServant = (InfluentValveOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.O2ConsumerDefinition _result;
			try
			{
	...
	public com.traclabs.biosim.idl.simulation.air.CO2ConsumerDefinition getCO2ConsumerDefinition()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getCO2ConsumerDefinition", true);
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			InfluentValveOperations _localServant = (InfluentValveOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.air.CO2ConsumerDefinition _result;
			try
			{
