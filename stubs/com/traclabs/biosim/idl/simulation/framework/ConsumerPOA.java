	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.framework.ConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "fixAllMalfunctions", Integer.valueOf(21));
	...
	public com.traclabs.biosim.idl.simulation.framework.Consumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.framework.Consumer __r = com.traclabs.biosim.idl.simulation.framework.ConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult6 = getModuleName();
