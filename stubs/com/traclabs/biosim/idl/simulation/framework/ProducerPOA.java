	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.framework.ProducerOperations
{
	...
	public com.traclabs.biosim.idl.simulation.framework.Producer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.framework.Producer __r = com.traclabs.biosim.idl.simulation.framework.ProducerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult7 = getModuleName();
