	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllableOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getTotalMaxFlowRate", Integer.valueOf(15));
		m_opsHash.put ( "connectsTo", Integer.valueOf(16));
		m_opsHash.put ( "getDesiredFlowRates", Integer.valueOf(17));
		m_opsHash.put ( "setMaxFlowRate", Integer.valueOf(18));
		m_opsHash.put ( "getDesiredFlowRate", Integer.valueOf(19));
		m_opsHash.put ( "getTotalDesiredFlowRate", Integer.valueOf(20));
	}
	...
	public com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllable _this()
	{
		...
		com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllable __r = com.traclabs.biosim.idl.simulation.framework.StoreFlowRateControllableHelper.narrow(__o);
		return __r;
	}
