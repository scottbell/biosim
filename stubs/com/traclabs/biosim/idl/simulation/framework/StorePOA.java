	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.framework.StoreOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "isFailureEnabled", Integer.valueOf(36));
	...
	public com.traclabs.biosim.idl.simulation.framework.Store _this()
	{
		...
		com.traclabs.biosim.idl.simulation.framework.Store __r = com.traclabs.biosim.idl.simulation.framework.StoreHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult9 = getModuleName();
