	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.framework.AccumulatorOperations
{
	...
	public com.traclabs.biosim.idl.simulation.framework.Accumulator _this()
	{
		...
		com.traclabs.biosim.idl.simulation.framework.Accumulator __r = com.traclabs.biosim.idl.simulation.framework.AccumulatorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult16 = getModuleName();
