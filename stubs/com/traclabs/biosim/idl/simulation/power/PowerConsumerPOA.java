	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.power.PowerConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getPowerConsumerDefinition", Integer.valueOf(10));
	...
	public com.traclabs.biosim.idl.simulation.power.PowerConsumer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.power.PowerConsumer __r = com.traclabs.biosim.idl.simulation.power.PowerConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult86 = getModuleName();
_out.write_string( tmpResult86 );
				break;
			}
