	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.power.PowerProducerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getPowerProducerDefinition", Integer.valueOf(21));
	...
	public com.traclabs.biosim.idl.simulation.power.PowerProducer _this()
	{
		...
		com.traclabs.biosim.idl.simulation.power.PowerProducer __r = com.traclabs.biosim.idl.simulation.power.PowerProducerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult87 = getModuleName();
