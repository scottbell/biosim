	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.power.GenericPowerConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getPercentageOfPowerAskedDelivered", Integer.valueOf(17));
		m_opsHash.put ( "setPowerRequired", Integer.valueOf(18));
		m_opsHash.put ( "tick", Integer.valueOf(19));
		m_opsHash.put ( "fixMalfunction", Integer.valueOf(20));
		m_opsHash.put ( "getMalfunctionNames", Integer.valueOf(21));
		...
		m_opsHash.put ( "fixAllMalfunctions", Integer.valueOf(27));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/power/GenericPowerConsumer:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SimBioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/power/PowerConsumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0"};
	public com.traclabs.biosim.idl.simulation.power.GenericPowerConsumer _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		com.traclabs.biosim.idl.simulation.power.GenericPowerConsumer __r = com.traclabs.biosim.idl.simulation.power.GenericPowerConsumerHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult81 = getModuleName();
