...
public abstract class GenericPowerConsumerHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(GenericPowerConsumerHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/simulation/power/GenericPowerConsumer:1.0", "GenericPowerConsumer");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.simulation.power._GenericPowerConsumerStub.class));
	}
	...
	public static com.traclabs.biosim.idl.simulation.power.GenericPowerConsumer narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.simulation.power.GenericPowerConsumer)
		{
			return (com.traclabs.biosim.idl.simulation.power.GenericPowerConsumer)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/simulation/power/GenericPowerConsumer:1.0"))
		{
