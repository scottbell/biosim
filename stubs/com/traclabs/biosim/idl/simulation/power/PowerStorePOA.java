	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.power.PowerStoreOperations
{
	...
	public com.traclabs.biosim.idl.simulation.power.PowerStore _this()
	{
		...
		com.traclabs.biosim.idl.simulation.power.PowerStore __r = com.traclabs.biosim.idl.simulation.power.PowerStoreHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult85 = getModuleName();
_out.write_string( tmpResult85 );
				break;
			}
