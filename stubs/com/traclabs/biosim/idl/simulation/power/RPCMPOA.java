	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.simulation.power.RPCMOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getSwitchState", Integer.valueOf(2));
		...
		m_opsHash.put ( "getArmedStatus", Integer.valueOf(18));
		...
		m_opsHash.put ( "getPowerProducerDefinition", Integer.valueOf(25));
		m_opsHash.put ( "log", Integer.valueOf(26));
		m_opsHash.put ( "setSwitchState", Integer.valueOf(27));
		m_opsHash.put ( "getMalfunctions", Integer.valueOf(28));
		m_opsHash.put ( "fixAllMalfunctions", Integer.valueOf(29));
		m_opsHash.put ( "setArmedStatus", Integer.valueOf(30));
	}
	private String[] ids = {"IDL:com/traclabs/biosim/idl/simulation/power/RPCM:1.0","IDL:com/traclabs/biosim/idl/simulation/framework/SimBioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/power/PowerConsumer:1.0","IDL:com/traclabs/biosim/idl/framework/BioModule:1.0","IDL:com/traclabs/biosim/idl/simulation/power/PowerProducer:1.0"};
	public com.traclabs.biosim.idl.simulation.power.RPCM _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		com.traclabs.biosim.idl.simulation.power.RPCM __r = com.traclabs.biosim.idl.simulation.power.RPCMHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult83 = getModuleName();
