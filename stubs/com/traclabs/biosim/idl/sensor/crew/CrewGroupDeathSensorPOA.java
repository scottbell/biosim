	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.crew.CrewGroupDeathSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.crew.CrewGroupDeathSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.crew.CrewGroupDeathSensor __r = com.traclabs.biosim.idl.sensor.crew.CrewGroupDeathSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult168 = getModuleName();
_out.write_string( tmpResult168 );
				break;
			}
