...
public abstract class CrewGroupActivitySensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(CrewGroupActivitySensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/crew/CrewGroupActivitySensor:1.0", "CrewGroupActivitySensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.crew._CrewGroupActivitySensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.crew.CrewGroupActivitySensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.crew.CrewGroupActivitySensor)
		{
			return (com.traclabs.biosim.idl.sensor.crew.CrewGroupActivitySensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/crew/CrewGroupActivitySensor:1.0"))
		{
