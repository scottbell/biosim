...
public abstract class CrewGroupProductivitySensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(CrewGroupProductivitySensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/crew/CrewGroupProductivitySensor:1.0", "CrewGroupProductivitySensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.crew._CrewGroupProductivitySensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.crew.CrewGroupProductivitySensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.crew.CrewGroupProductivitySensor)
		{
			return (com.traclabs.biosim.idl.sensor.crew.CrewGroupProductivitySensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/crew/CrewGroupProductivitySensor:1.0"))
		{
