...
public abstract class CrewGroupDeathSensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(CrewGroupDeathSensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/crew/CrewGroupDeathSensor:1.0", "CrewGroupDeathSensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.crew._CrewGroupDeathSensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.crew.CrewGroupDeathSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.crew.CrewGroupDeathSensor)
		{
			return (com.traclabs.biosim.idl.sensor.crew.CrewGroupDeathSensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/crew/CrewGroupDeathSensor:1.0"))
		{
