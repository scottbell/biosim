	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.crew.CrewGroupAnyDeadSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", Integer.valueOf(25));
		m_opsHash.put ( "getInputModule", Integer.valueOf(26));
	...
	public com.traclabs.biosim.idl.sensor.crew.CrewGroupAnyDeadSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.crew.CrewGroupAnyDeadSensor __r = com.traclabs.biosim.idl.sensor.crew.CrewGroupAnyDeadSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult169 = getModuleName();
_out.write_string( tmpResult169 );
				break;
			}
