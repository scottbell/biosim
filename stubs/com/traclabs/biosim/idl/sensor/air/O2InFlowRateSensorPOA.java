	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.air.O2InFlowRateSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", Integer.valueOf(19));
	...
	public com.traclabs.biosim.idl.sensor.air.O2InFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.air.O2InFlowRateSensor __r = com.traclabs.biosim.idl.sensor.air.O2InFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult155 = getModuleName();
_out.write_string( tmpResult155 );
				break;
			}
