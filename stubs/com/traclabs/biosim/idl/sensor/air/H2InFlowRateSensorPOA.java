	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.air.H2InFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.air.H2InFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.air.H2InFlowRateSensor __r = com.traclabs.biosim.idl.sensor.air.H2InFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult159 = getModuleName();
_out.write_string( tmpResult159 );
				break;
			}
