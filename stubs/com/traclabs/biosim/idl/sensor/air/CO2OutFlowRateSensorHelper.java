...
public abstract class CO2OutFlowRateSensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(CO2OutFlowRateSensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/air/CO2OutFlowRateSensor:1.0", "CO2OutFlowRateSensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.air._CO2OutFlowRateSensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.air.CO2OutFlowRateSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.air.CO2OutFlowRateSensor)
		{
			return (com.traclabs.biosim.idl.sensor.air.CO2OutFlowRateSensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/air/CO2OutFlowRateSensor:1.0"))
		{
