	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.air.H2OutFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.air.H2OutFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.air.H2OutFlowRateSensor __r = com.traclabs.biosim.idl.sensor.air.H2OutFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult160 = getModuleName();
