	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.air.CO2OutFlowRateSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", Integer.valueOf(9));
	...
	public com.traclabs.biosim.idl.sensor.air.CO2OutFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.air.CO2OutFlowRateSensor __r = com.traclabs.biosim.idl.sensor.air.CO2OutFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult158 = getModuleName();
_out.write_string( tmpResult158 );
				break;
			}
