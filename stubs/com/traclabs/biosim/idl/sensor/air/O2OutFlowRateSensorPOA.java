	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.air.O2OutFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.air.O2OutFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.air.O2OutFlowRateSensor __r = com.traclabs.biosim.idl.sensor.air.O2OutFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult156 = getModuleName();
_out.write_string( tmpResult156 );
				break;
			}
