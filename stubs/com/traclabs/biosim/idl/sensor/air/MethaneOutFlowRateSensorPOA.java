	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.air.MethaneOutFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.air.MethaneOutFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.air.MethaneOutFlowRateSensor __r = com.traclabs.biosim.idl.sensor.air.MethaneOutFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult164 = getModuleName();
