...
public abstract class H2InFlowRateSensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(H2InFlowRateSensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/air/H2InFlowRateSensor:1.0", "H2InFlowRateSensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.air._H2InFlowRateSensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.air.H2InFlowRateSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.air.H2InFlowRateSensor)
		{
			return (com.traclabs.biosim.idl.sensor.air.H2InFlowRateSensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/air/H2InFlowRateSensor:1.0"))
		{
