	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.air.CO2InFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.air.CO2InFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.air.CO2InFlowRateSensor __r = com.traclabs.biosim.idl.sensor.air.CO2InFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult157 = getModuleName();
_out.write_string( tmpResult157 );
				break;
			}
