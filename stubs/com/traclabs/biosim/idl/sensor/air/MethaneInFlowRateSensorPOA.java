	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.air.MethaneInFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.air.MethaneInFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.air.MethaneInFlowRateSensor __r = com.traclabs.biosim.idl.sensor.air.MethaneInFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult163 = getModuleName();
