	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.framework.GenericSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "fixAllMalfunctions", Integer.valueOf(25));
		m_opsHash.put ( "getMalfunctions", Integer.valueOf(26));
	}
	...
	public com.traclabs.biosim.idl.sensor.framework.GenericSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.framework.GenericSensor __r = com.traclabs.biosim.idl.sensor.framework.GenericSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult146 = getModuleName();
_out.write_string( tmpResult146 );
				break;
			}
			case 16: // tick
			{
