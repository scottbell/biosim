...
public abstract class EffluentValveStateSensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(EffluentValveStateSensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/framework/EffluentValveStateSensor:1.0", "EffluentValveStateSensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.framework._EffluentValveStateSensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensor)
		{
			return (com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/framework/EffluentValveStateSensor:1.0"))
		{
