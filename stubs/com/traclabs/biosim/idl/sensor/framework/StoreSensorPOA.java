	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.framework.StoreSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.framework.StoreSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.framework.StoreSensor __r = com.traclabs.biosim.idl.sensor.framework.StoreSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult147 = getModuleName();
_out.write_string( tmpResult147 );
				break;
			}
