	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.framework.InfluentValveStateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.framework.InfluentValveStateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.framework.InfluentValveStateSensor __r = com.traclabs.biosim.idl.sensor.framework.InfluentValveStateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult152 = getModuleName();
_out.write_string( tmpResult152 );
				break;
			}
