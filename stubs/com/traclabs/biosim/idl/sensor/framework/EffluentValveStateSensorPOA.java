	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", Integer.valueOf(6));
	...
	public com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensor __r = com.traclabs.biosim.idl.sensor.framework.EffluentValveStateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult154 = getModuleName();
_out.write_string( tmpResult154 );
				break;
			}
			case 18: // tick
			{
