	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.framework.InfluentValveSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", Integer.valueOf(18));
	...
	public com.traclabs.biosim.idl.sensor.framework.InfluentValveSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.framework.InfluentValveSensor __r = com.traclabs.biosim.idl.sensor.framework.InfluentValveSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult151 = getModuleName();
