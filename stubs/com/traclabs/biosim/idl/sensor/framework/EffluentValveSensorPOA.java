	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.framework.EffluentValveSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.framework.EffluentValveSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.framework.EffluentValveSensor __r = com.traclabs.biosim.idl.sensor.framework.EffluentValveSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult153 = getModuleName();
_out.write_string( tmpResult153 );
				break;
			}
