	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.framework.TimeSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getValue", Integer.valueOf(13));
		m_opsHash.put ( "getModuleName", Integer.valueOf(14));
		m_opsHash.put ( "scheduleMalfunction", Integer.valueOf(15));
		m_opsHash.put ( "tick", Integer.valueOf(16));
		m_opsHash.put ( "fixMalfunction", Integer.valueOf(17));
		m_opsHash.put ( "getMalfunctionNames", Integer.valueOf(18));
		m_opsHash.put ( "setTickLength", Integer.valueOf(19));
		m_opsHash.put ( "isFailureEnabled", Integer.valueOf(20));
		m_opsHash.put ( "startMalfunction", Integer.valueOf(21));
		m_opsHash.put ( "log", Integer.valueOf(22));
		m_opsHash.put ( "getMin", Integer.valueOf(23));
		m_opsHash.put ( "getInputModule", Integer.valueOf(24));
	...
	public com.traclabs.biosim.idl.sensor.framework.TimeSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.framework.TimeSensor __r = com.traclabs.biosim.idl.sensor.framework.TimeSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult148 = getModuleName();
