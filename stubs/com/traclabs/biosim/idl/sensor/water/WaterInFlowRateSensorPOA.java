	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.water.WaterInFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.water.WaterInFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.water.WaterInFlowRateSensor __r = com.traclabs.biosim.idl.sensor.water.WaterInFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult197 = getModuleName();
_out.write_string( tmpResult197 );
				break;
			}
