	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.water.PotableWaterInFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.water.PotableWaterInFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.water.PotableWaterInFlowRateSensor __r = com.traclabs.biosim.idl.sensor.water.PotableWaterInFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult191 = getModuleName();
_out.write_string( tmpResult191 );
				break;
			}
