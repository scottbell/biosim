...
public abstract class PotableWaterOutFlowRateSensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(PotableWaterOutFlowRateSensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/water/PotableWaterOutFlowRateSensor:1.0", "PotableWaterOutFlowRateSensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.water._PotableWaterOutFlowRateSensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.water.PotableWaterOutFlowRateSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.water.PotableWaterOutFlowRateSensor)
		{
			return (com.traclabs.biosim.idl.sensor.water.PotableWaterOutFlowRateSensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/water/PotableWaterOutFlowRateSensor:1.0"))
		{
