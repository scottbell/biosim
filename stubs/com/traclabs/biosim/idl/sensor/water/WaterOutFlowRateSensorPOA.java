	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.water.WaterOutFlowRateSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", Integer.valueOf(8));
	...
	public com.traclabs.biosim.idl.sensor.water.WaterOutFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.water.WaterOutFlowRateSensor __r = com.traclabs.biosim.idl.sensor.water.WaterOutFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult198 = getModuleName();
_out.write_string( tmpResult198 );
				break;
			}
