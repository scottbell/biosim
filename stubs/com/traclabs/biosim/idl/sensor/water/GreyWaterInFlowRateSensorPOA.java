	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.water.GreyWaterInFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.water.GreyWaterInFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.water.GreyWaterInFlowRateSensor __r = com.traclabs.biosim.idl.sensor.water.GreyWaterInFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult193 = getModuleName();
_out.write_string( tmpResult193 );
				break;
			}
