	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.water.DirtyWaterInFlowRateSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", Integer.valueOf(12));
	...
	public com.traclabs.biosim.idl.sensor.water.DirtyWaterInFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.water.DirtyWaterInFlowRateSensor __r = com.traclabs.biosim.idl.sensor.water.DirtyWaterInFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult195 = getModuleName();
_out.write_string( tmpResult195 );
				break;
			}
