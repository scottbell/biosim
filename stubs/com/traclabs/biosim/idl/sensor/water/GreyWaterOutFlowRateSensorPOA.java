	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.water.GreyWaterOutFlowRateSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getMin", Integer.valueOf(25));
		m_opsHash.put ( "getInputModule", Integer.valueOf(26));
		m_opsHash.put ( "setInput", Integer.valueOf(27));
	...
	public com.traclabs.biosim.idl.sensor.water.GreyWaterOutFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.water.GreyWaterOutFlowRateSensor __r = com.traclabs.biosim.idl.sensor.water.GreyWaterOutFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult194 = getModuleName();
_out.write_string( tmpResult194 );
				break;
			}
