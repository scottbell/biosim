	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.HarvestSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.food.HarvestSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.food.HarvestSensor __r = com.traclabs.biosim.idl.sensor.food.HarvestSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult184 = getModuleName();
_out.write_string( tmpResult184 );
				break;
			}
			case 18: // tick
			{
