	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.BiomassStoreSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.food.BiomassStoreSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.food.BiomassStoreSensor __r = com.traclabs.biosim.idl.sensor.food.BiomassStoreSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult177 = getModuleName();
_out.write_string( tmpResult177 );
				break;
			}
