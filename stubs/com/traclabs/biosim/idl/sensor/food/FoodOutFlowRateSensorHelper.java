...
public abstract class FoodOutFlowRateSensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(FoodOutFlowRateSensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/food/FoodOutFlowRateSensor:1.0", "FoodOutFlowRateSensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.food._FoodOutFlowRateSensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.food.FoodOutFlowRateSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.food.FoodOutFlowRateSensor)
		{
			return (com.traclabs.biosim.idl.sensor.food.FoodOutFlowRateSensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/food/FoodOutFlowRateSensor:1.0"))
		{
