	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.BiomassInFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.food.BiomassInFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.food.BiomassInFlowRateSensor __r = com.traclabs.biosim.idl.sensor.food.BiomassInFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult179 = getModuleName();
_out.write_string( tmpResult179 );
				break;
			}
