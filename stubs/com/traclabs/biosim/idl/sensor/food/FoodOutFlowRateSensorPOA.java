	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.FoodOutFlowRateSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", Integer.valueOf(2));
	...
	public com.traclabs.biosim.idl.sensor.food.FoodOutFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.food.FoodOutFlowRateSensor __r = com.traclabs.biosim.idl.sensor.food.FoodOutFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult182 = getModuleName();
_out.write_string( tmpResult182 );
				break;
			}
