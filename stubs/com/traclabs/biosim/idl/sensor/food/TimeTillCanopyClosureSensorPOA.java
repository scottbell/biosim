	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.TimeTillCanopyClosureSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.food.TimeTillCanopyClosureSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.food.TimeTillCanopyClosureSensor __r = com.traclabs.biosim.idl.sensor.food.TimeTillCanopyClosureSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult186 = getModuleName();
