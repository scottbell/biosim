...
public abstract class HarvestSensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(HarvestSensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/food/HarvestSensor:1.0", "HarvestSensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.food._HarvestSensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.food.HarvestSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.food.HarvestSensor)
		{
			return (com.traclabs.biosim.idl.sensor.food.HarvestSensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/food/HarvestSensor:1.0"))
		{
