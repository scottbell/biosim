	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.PlantDeathSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", Integer.valueOf(1));
	...
	public com.traclabs.biosim.idl.sensor.food.PlantDeathSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.food.PlantDeathSensor __r = com.traclabs.biosim.idl.sensor.food.PlantDeathSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult185 = getModuleName();
_out.write_string( tmpResult185 );
				break;
			}
			case 18: // tick
			{
