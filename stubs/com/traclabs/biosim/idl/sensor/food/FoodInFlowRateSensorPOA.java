	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.FoodInFlowRateSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", Integer.valueOf(3));
	...
	public com.traclabs.biosim.idl.sensor.food.FoodInFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.food.FoodInFlowRateSensor __r = com.traclabs.biosim.idl.sensor.food.FoodInFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult181 = getModuleName();
_out.write_string( tmpResult181 );
				break;
			}
