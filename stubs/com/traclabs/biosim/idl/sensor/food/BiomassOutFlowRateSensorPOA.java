	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.food.BiomassOutFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.food.BiomassOutFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.food.BiomassOutFlowRateSensor __r = com.traclabs.biosim.idl.sensor.food.BiomassOutFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult180 = getModuleName();
_out.write_string( tmpResult180 );
				break;
			}
