	...
	implements com.traclabs.biosim.idl.sensor.environment.GasConcentrationSensor
{
	...
	public void setInput(com.traclabs.biosim.idl.simulation.environment.SimEnvironment _environment, com.traclabs.biosim.idl.simulation.environment.EnvironmentStore gas)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setInput", true);
					com.traclabs.biosim.idl.simulation.environment.SimEnvironmentHelper.write(_os,_environment);
		...
		else
		{
			...
			try
			{
				_localServant.setInput(_environment,gas);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public com.traclabs.biosim.idl.simulation.environment.SimEnvironment getEnvironment()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getEnvironment", true);
					_is = _invoke(_os);
	...
	public com.traclabs.biosim.idl.simulation.environment.EnvironmentStore getGas()
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			GasConcentrationSensorOperations _localServant = (GasConcentrationSensorOperations)_so.servant;
			com.traclabs.biosim.idl.simulation.environment.EnvironmentStore _result;
			try
			{
	...
	public com.traclabs.biosim.idl.framework.BioModule getInputModule()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getInputModule", true);
					_is = _invoke(_os);
