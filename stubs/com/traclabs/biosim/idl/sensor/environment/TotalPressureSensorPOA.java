	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.environment.TotalPressureSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", Integer.valueOf(26));
	...
	public com.traclabs.biosim.idl.sensor.environment.TotalPressureSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.environment.TotalPressureSensor __r = com.traclabs.biosim.idl.sensor.environment.TotalPressureSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult171 = getModuleName();
_out.write_string( tmpResult171 );
				break;
			}
