	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensor __r = com.traclabs.biosim.idl.sensor.environment.AirInFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult175 = getModuleName();
