...
public abstract class TotalMolesSensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(TotalMolesSensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/environment/TotalMolesSensor:1.0", "TotalMolesSensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.environment._TotalMolesSensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.environment.TotalMolesSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.environment.TotalMolesSensor)
		{
			return (com.traclabs.biosim.idl.sensor.environment.TotalMolesSensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/environment/TotalMolesSensor:1.0"))
		{
