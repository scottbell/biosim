	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.environment.TotalMolesSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.environment.TotalMolesSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.environment.TotalMolesSensor __r = com.traclabs.biosim.idl.sensor.environment.TotalMolesSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult172 = getModuleName();
_out.write_string( tmpResult172 );
				break;
			}
