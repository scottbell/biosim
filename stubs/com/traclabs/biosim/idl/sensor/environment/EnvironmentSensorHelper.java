...
public abstract class EnvironmentSensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(EnvironmentSensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/environment/EnvironmentSensor:1.0", "EnvironmentSensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.environment._EnvironmentSensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.environment.EnvironmentSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.environment.EnvironmentSensor)
		{
			return (com.traclabs.biosim.idl.sensor.environment.EnvironmentSensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/environment/EnvironmentSensor:1.0"))
		{
