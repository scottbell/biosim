...
public abstract class GasConcentrationSensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(GasConcentrationSensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/environment/GasConcentrationSensor:1.0", "GasConcentrationSensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.environment._GasConcentrationSensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.environment.GasConcentrationSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.environment.GasConcentrationSensor)
		{
			return (com.traclabs.biosim.idl.sensor.environment.GasConcentrationSensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/environment/GasConcentrationSensor:1.0"))
		{
