	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.environment.EnvironmentSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.environment.EnvironmentSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.environment.EnvironmentSensor __r = com.traclabs.biosim.idl.sensor.environment.EnvironmentSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult170 = getModuleName();
_out.write_string( tmpResult170 );
				break;
			}
