	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.environment.GasPressureSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", Integer.valueOf(23));
	...
	public com.traclabs.biosim.idl.sensor.environment.GasPressureSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.environment.GasPressureSensor __r = com.traclabs.biosim.idl.sensor.environment.GasPressureSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult173 = getModuleName();
