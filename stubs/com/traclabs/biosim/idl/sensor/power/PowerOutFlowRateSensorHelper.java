...
public abstract class PowerOutFlowRateSensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(PowerOutFlowRateSensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/power/PowerOutFlowRateSensor:1.0", "PowerOutFlowRateSensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.power._PowerOutFlowRateSensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensor)
		{
			return (com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/power/PowerOutFlowRateSensor:1.0"))
		{
