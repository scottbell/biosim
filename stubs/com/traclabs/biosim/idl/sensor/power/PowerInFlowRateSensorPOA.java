	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.power.PowerInFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.power.PowerInFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.power.PowerInFlowRateSensor __r = com.traclabs.biosim.idl.sensor.power.PowerInFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult187 = getModuleName();
