	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensor __r = com.traclabs.biosim.idl.sensor.power.PowerOutFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult188 = getModuleName();
