...
public abstract class DryWasteOutFlowRateSensorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(DryWasteOutFlowRateSensorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:com/traclabs/biosim/idl/sensor/waste/DryWasteOutFlowRateSensor:1.0", "DryWasteOutFlowRateSensor");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(com.traclabs.biosim.idl.sensor.waste._DryWasteOutFlowRateSensorStub.class));
	}
	...
	public static com.traclabs.biosim.idl.sensor.waste.DryWasteOutFlowRateSensor narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof com.traclabs.biosim.idl.sensor.waste.DryWasteOutFlowRateSensor)
		{
			return (com.traclabs.biosim.idl.sensor.waste.DryWasteOutFlowRateSensor)obj;
		}
		else if (obj._is_a("IDL:com/traclabs/biosim/idl/sensor/waste/DryWasteOutFlowRateSensor:1.0"))
		{
