	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.waste.DryWasteInFlowRateSensorOperations
{
	...
	public com.traclabs.biosim.idl.sensor.waste.DryWasteInFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.waste.DryWasteInFlowRateSensor __r = com.traclabs.biosim.idl.sensor.waste.DryWasteInFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult189 = getModuleName();
