	...
	implements org.omg.CORBA.portable.InvokeHandler, com.traclabs.biosim.idl.sensor.waste.DryWasteOutFlowRateSensorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setInput", Integer.valueOf(22));
	...
	public com.traclabs.biosim.idl.sensor.waste.DryWasteOutFlowRateSensor _this()
	{
		...
		com.traclabs.biosim.idl.sensor.waste.DryWasteOutFlowRateSensor __r = com.traclabs.biosim.idl.sensor.waste.DryWasteOutFlowRateSensorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult190 = getModuleName();
_out.write_string( tmpResult190 );
				break;
			}
